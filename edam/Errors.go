...
func (p *EDAMUserException) Equals(other *EDAMUserException) bool {
  if p == other {
    return true
  ...
  if p.Parameter != other.Parameter {
    if p.Parameter == nil || other.Parameter == nil {
      return false
    }
    if (*p.Parameter) != (*other.Parameter) { return false }
  }
  return true
}
...
func (EDAMUserException) TExceptionType() thrift.TExceptionType {
  return thrift.TExceptionTypeCompiled
}

var _ thrift.TException = (*EDAMUserException)(nil)
...
func (p *EDAMSystemException) Equals(other *EDAMSystemException) bool {
  if p == other {
    return true
  } else if p == nil || other == nil {
    return false
  ...
  if p.RateLimitDuration != other.RateLimitDuration {
    if p.RateLimitDuration == nil || other.RateLimitDuration == nil {
      return false
    }
    if (*p.RateLimitDuration) != (*other.RateLimitDuration) { return false }
  }
  return true
}
...
func (EDAMSystemException) TExceptionType() thrift.TExceptionType {
  return thrift.TExceptionTypeCompiled
}

var _ thrift.TException = (*EDAMSystemException)(nil)
...
func (p *EDAMNotFoundException) Equals(other *EDAMNotFoundException) bool {
  if p == other {
    return true
  } else if p == nil || other == nil {
    return false
...
func (EDAMNotFoundException) TExceptionType() thrift.TExceptionType {
  return thrift.TExceptionTypeCompiled
}

var _ thrift.TException = (*EDAMNotFoundException)(nil)
...
func (p *EDAMInvalidContactsException) Read(ctx context.Context, iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(ctx); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *EDAMInvalidContactsException)  ReadField1(ctx context.Context, iprot thrift.TProtocol) error {
...
func (p *EDAMInvalidContactsException)  ReadField2(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(ctx); err != nil {
  return thrift.PrependError("error reading field 2: ", err)
} else {
  p.Parameter = &v
...
func (p *EDAMInvalidContactsException)  ReadField3(ctx context.Context, iprot thrift.TProtocol) error {
  _, size, err := iprot.ReadListBegin(ctx)
  if err != nil {
    return thrift.PrependError("error reading list begin: ", err)
  }
...
func (p *EDAMInvalidContactsException) Write(ctx context.Context, oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin(ctx, "EDAMInvalidContactsException"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if p != nil {
    if err := p.writeField1(ctx, oprot); err != nil { return err }
    if err := p.writeField2(ctx, oprot); err != nil { return err }
...
func (p *EDAMInvalidContactsException) writeField1(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin(ctx, "contacts", thrift.LIST, 1); err != nil {
...
func (p *EDAMInvalidContactsException) writeField2(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetParameter() {
    if err := oprot.WriteFieldBegin(ctx, "parameter", thrift.STRING, 2); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 2:parameter: ", p), err) }
    if err := oprot.WriteString(ctx, string(*p.Parameter)); err != nil {
...
func (p *EDAMInvalidContactsException) writeField3(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetReasons() {
    if err := oprot.WriteFieldBegin(ctx, "reasons", thrift.LIST, 3); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 3:reasons: ", p), err) }
    if err := oprot.WriteListBegin(ctx, thrift.I32, len(p.Reasons)); err != nil {
      return thrift.PrependError("error writing list begin: ", err)
    }
...
func (p *EDAMInvalidContactsException) Equals(other *EDAMInvalidContactsException) bool {
  if p == other {
    return true
  } else if p == nil || other == nil {
    return false
...
func (EDAMInvalidContactsException) TExceptionType() thrift.TExceptionType {
  return thrift.TExceptionTypeCompiled
}

var _ thrift.TException = (*EDAMInvalidContactsException)(nil)
