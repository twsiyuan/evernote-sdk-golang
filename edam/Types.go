...
func (p *Data) writeField1(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetBodyHash() {
    if err := oprot.WriteFieldBegin(ctx, "bodyHash", thrift.STRING, 1); err != nil {
...
func (p *Data) Equals(other *Data) bool {
  ...
  if bytes.Compare(p.BodyHash, other.BodyHash) != 0 { return false }
...
func (p *UserAttributes)  ReadField35(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(ctx); err != nil {
...
func (p *UserAttributes)  ReadField36(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(ctx); err != nil {
...
func (p *UserAttributes)  ReadField37(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadBool(ctx); err != nil {
...
func (p *UserAttributes)  ReadField38(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadBool(ctx); err != nil {
...
func (p *UserAttributes)  ReadField39(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadBool(ctx); err != nil {
...
func (p *UserAttributes) writeField35(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetEmailAddressLastConfirmed() {
    if err := oprot.WriteFieldBegin(ctx, "emailAddressLastConfirmed", thrift.I64, 35); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 35:emailAddressLastConfirmed: ", p), err) }
    if err := oprot.WriteI64(ctx, int64(*p.EmailAddressLastConfirmed)); err != nil {
...
func (p *UserAttributes) writeField36(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetPasswordUpdated() {
    if err := oprot.WriteFieldBegin(ctx, "passwordUpdated", thrift.I64, 36); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 36:passwordUpdated: ", p), err) }
    if err := oprot.WriteI64(ctx, int64(*p.PasswordUpdated)); err != nil {
...
func (p *UserAttributes) writeField37(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetSalesforcePushEnabled() {
    if err := oprot.WriteFieldBegin(ctx, "salesforcePushEnabled", thrift.BOOL, 37); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 37:salesforcePushEnabled: ", p), err) }
    if err := oprot.WriteBool(ctx, bool(*p.SalesforcePushEnabled)); err != nil {
...
func (p *UserAttributes) writeField38(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetShouldLogClientEvent() {
    if err := oprot.WriteFieldBegin(ctx, "shouldLogClientEvent", thrift.BOOL, 38); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 38:shouldLogClientEvent: ", p), err) }
    if err := oprot.WriteBool(ctx, bool(*p.ShouldLogClientEvent)); err != nil {
...
func (p *UserAttributes) writeField39(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetOptOutMachineLearning() {
    if err := oprot.WriteFieldBegin(ctx, "optOutMachineLearning", thrift.BOOL, 39); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 39:optOutMachineLearning: ", p), err) }
    if err := oprot.WriteBool(ctx, bool(*p.OptOutMachineLearning)); err != nil {
...
func (p *UserAttributes) Equals(other *UserAttributes) bool {
  if p == other {
    return true
  } else if p == nil || other == nil {
    return false
  }
  if p.DefaultLocationName != other.DefaultLocationName {
    if p.DefaultLocationName == nil || other.DefaultLocationName == nil {
      return false
    }
    if (*p.DefaultLocationName) != (*other.DefaultLocationName) { return false }
  }
  if p.DefaultLatitude != other.DefaultLatitude {
    if p.DefaultLatitude == nil || other.DefaultLatitude == nil {
      return false
    }
    if (*p.DefaultLatitude) != (*other.DefaultLatitude) { return false }
  }
  if p.DefaultLongitude != other.DefaultLongitude {
    if p.DefaultLongitude == nil || other.DefaultLongitude == nil {
      return false
    }
    if (*p.DefaultLongitude) != (*other.DefaultLongitude) { return false }
  }
  if p.Preactivation != other.Preactivation {
    if p.Preactivation == nil || other.Preactivation == nil {
      return false
    }
    if (*p.Preactivation) != (*other.Preactivation) { return false }
  }
  if len(p.ViewedPromotions) != len(other.ViewedPromotions) { return false }
  for i, _tgt := range p.ViewedPromotions {
    _src2 := other.ViewedPromotions[i]
    if _tgt != _src2 { return false }
  }
  if p.IncomingEmailAddress != other.IncomingEmailAddress {
    if p.IncomingEmailAddress == nil || other.IncomingEmailAddress == nil {
      return false
    }
    if (*p.IncomingEmailAddress) != (*other.IncomingEmailAddress) { return false }
  }
  if len(p.RecentMailedAddresses) != len(other.RecentMailedAddresses) { return false }
  for i, _tgt := range p.RecentMailedAddresses {
    _src3 := other.RecentMailedAddresses[i]
  ...
  if p.DateAgreedToTermsOfService != other.DateAgreedToTermsOfService {
    if p.DateAgreedToTermsOfService == nil || other.DateAgreedToTermsOfService == nil {
      return false
    }
    if (*p.DateAgreedToTermsOfService) != (*other.DateAgreedToTermsOfService) { return false }
  }
  if p.MaxReferrals != other.MaxReferrals {
    if p.MaxReferrals == nil || other.MaxReferrals == nil {
      return false
    }
    if (*p.MaxReferrals) != (*other.MaxReferrals) { return false }
  }
  if p.ReferralCount != other.ReferralCount {
    if p.ReferralCount == nil || other.ReferralCount == nil {
      return false
    }
    if (*p.ReferralCount) != (*other.ReferralCount) { return false }
  }
  if p.RefererCode != other.RefererCode {
    if p.RefererCode == nil || other.RefererCode == nil {
      return false
    }
    if (*p.RefererCode) != (*other.RefererCode) { return false }
  }
  if p.SentEmailDate != other.SentEmailDate {
    if p.SentEmailDate == nil || other.SentEmailDate == nil {
      return false
    }
    if (*p.SentEmailDate) != (*other.SentEmailDate) { return false }
  }
  if p.SentEmailCount != other.SentEmailCount {
    if p.SentEmailCount == nil || other.SentEmailCount == nil {
      return false
    }
    if (*p.SentEmailCount) != (*other.SentEmailCount) { return false }
  }
  if p.DailyEmailLimit != other.DailyEmailLimit {
    if p.DailyEmailLimit == nil || other.DailyEmailLimit == nil {
      return false
    }
    if (*p.DailyEmailLimit) != (*other.DailyEmailLimit) { return false }
  }
  if p.EmailOptOutDate != other.EmailOptOutDate {
    if p.EmailOptOutDate == nil || other.EmailOptOutDate == nil {
      return false
    }
    if (*p.EmailOptOutDate) != (*other.EmailOptOutDate) { return false }
  }
  if p.PartnerEmailOptInDate != other.PartnerEmailOptInDate {
    if p.PartnerEmailOptInDate == nil || other.PartnerEmailOptInDate == nil {
      return false
    }
    if (*p.PartnerEmailOptInDate) != (*other.PartnerEmailOptInDate) { return false }
  }
  if p.PreferredLanguage != other.PreferredLanguage {
    if p.PreferredLanguage == nil || other.PreferredLanguage == nil {
      return false
    }
    if (*p.PreferredLanguage) != (*other.PreferredLanguage) { return false }
  }
  if p.PreferredCountry != other.PreferredCountry {
    if p.PreferredCountry == nil || other.PreferredCountry == nil {
      return false
    }
    if (*p.PreferredCountry) != (*other.PreferredCountry) { return false }
  }
  if p.ClipFullPage != other.ClipFullPage {
    if p.ClipFullPage == nil || other.ClipFullPage == nil {
      return false
    }
    if (*p.ClipFullPage) != (*other.ClipFullPage) { return false }
  }
  if p.TwitterUserName != other.TwitterUserName {
    if p.TwitterUserName == nil || other.TwitterUserName == nil {
      return false
    }
    if (*p.TwitterUserName) != (*other.TwitterUserName) { return false }
  }
  if p.TwitterId != other.TwitterId {
    if p.TwitterId == nil || other.TwitterId == nil {
      return false
    }
    if (*p.TwitterId) != (*other.TwitterId) { return false }
  }
  ...
  if p.RecognitionLanguage != other.RecognitionLanguage {
    if p.RecognitionLanguage == nil || other.RecognitionLanguage == nil {
      return false
    }
    if (*p.RecognitionLanguage) != (*other.RecognitionLanguage) { return false }
  }
  if p.ReferralProof != other.ReferralProof {
    if p.ReferralProof == nil || other.ReferralProof == nil {
      return false
    }
    if (*p.ReferralProof) != (*other.ReferralProof) { return false }
  }
  if p.EducationalDiscount != other.EducationalDiscount {
    if p.EducationalDiscount == nil || other.EducationalDiscount == nil {
      return false
    }
    if (*p.EducationalDiscount) != (*other.EducationalDiscount) { return false }
  }
  if p.BusinessAddress != other.BusinessAddress {
    if p.BusinessAddress == nil || other.BusinessAddress == nil {
      return false
    }
    if (*p.BusinessAddress) != (*other.BusinessAddress) { return false }
  }
  if p.HideSponsorBilling != other.HideSponsorBilling {
    if p.HideSponsorBilling == nil || other.HideSponsorBilling == nil {
      return false
    }
    if (*p.HideSponsorBilling) != (*other.HideSponsorBilling) { return false }
  }
  if p.UseEmailAutoFiling != other.UseEmailAutoFiling {
    if p.UseEmailAutoFiling == nil || other.UseEmailAutoFiling == nil {
      return false
    }
    if (*p.UseEmailAutoFiling) != (*other.UseEmailAutoFiling) { return false }
  }
  if p.ReminderEmailConfig != other.ReminderEmailConfig {
    if p.ReminderEmailConfig == nil || other.ReminderEmailConfig == nil {
      return false
    }
    if (*p.ReminderEmailConfig) != (*other.ReminderEmailConfig) { return false }
  }
  if p.EmailAddressLastConfirmed != other.EmailAddressLastConfirmed {
    if p.EmailAddressLastConfirmed == nil || other.EmailAddressLastConfirmed == nil {
      return false
    }
    if (*p.EmailAddressLastConfirmed) != (*other.EmailAddressLastConfirmed) { return false }
  }
  if p.PasswordUpdated != other.PasswordUpdated {
    if p.PasswordUpdated == nil || other.PasswordUpdated == nil {
      return false
    }
    if (*p.PasswordUpdated) != (*other.PasswordUpdated) { return false }
  }
  if p.SalesforcePushEnabled != other.SalesforcePushEnabled {
    if p.SalesforcePushEnabled == nil || other.SalesforcePushEnabled == nil {
      return false
    }
    if (*p.SalesforcePushEnabled) != (*other.SalesforcePushEnabled) { return false }
  }
  if p.ShouldLogClientEvent != other.ShouldLogClientEvent {
    if p.ShouldLogClientEvent == nil || other.ShouldLogClientEvent == nil {
      return false
    }
    if (*p.ShouldLogClientEvent) != (*other.ShouldLogClientEvent) { return false }
  }
  if p.OptOutMachineLearning != other.OptOutMachineLearning {
    if p.OptOutMachineLearning == nil || other.OptOutMachineLearning == nil {
      return false
    }
    if (*p.OptOutMachineLearning) != (*other.OptOutMachineLearning) { return false }
  }
  return true
}
...
func (p *BusinessUserAttributes) Read(ctx context.Context, iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(ctx); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *BusinessUserAttributes)  ReadField1(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(ctx); err != nil {
  return thrift.PrependError("error reading field 1: ", err)
} else {
  p.Title = &v
...
func (p *BusinessUserAttributes)  ReadField2(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(ctx); err != nil {
  return thrift.PrependError("error reading field 2: ", err)
} else {
  p.Location = &v
...
func (p *BusinessUserAttributes)  ReadField3(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(ctx); err != nil {
  return thrift.PrependError("error reading field 3: ", err)
} else {
  p.Department = &v
...
func (p *BusinessUserAttributes)  ReadField4(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(ctx); err != nil {
  return thrift.PrependError("error reading field 4: ", err)
} else {
  p.MobilePhone = &v
...
func (p *BusinessUserAttributes)  ReadField5(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(ctx); err != nil {
...
func (p *BusinessUserAttributes)  ReadField6(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(ctx); err != nil {
  return thrift.PrependError("error reading field 6: ", err)
} else {
  p.WorkPhone = &v
...
func (p *BusinessUserAttributes)  ReadField7(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(ctx); err != nil {
...
func (p *BusinessUserAttributes) Write(ctx context.Context, oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin(ctx, "BusinessUserAttributes"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if p != nil {
    if err := p.writeField1(ctx, oprot); err != nil { return err }
    if err := p.writeField2(ctx, oprot); err != nil { return err }
...
func (p *BusinessUserAttributes) writeField1(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetTitle() {
...
func (p *BusinessUserAttributes) writeField2(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetLocation() {
...
func (p *BusinessUserAttributes) writeField3(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetDepartment() {
    if err := oprot.WriteFieldBegin(ctx, "department", thrift.STRING, 3); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 3:department: ", p), err) }
    if err := oprot.WriteString(ctx, string(*p.Department)); err != nil {
...
func (p *BusinessUserAttributes) writeField4(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetMobilePhone() {
    if err := oprot.WriteFieldBegin(ctx, "mobilePhone", thrift.STRING, 4); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 4:mobilePhone: ", p), err) }
    if err := oprot.WriteString(ctx, string(*p.MobilePhone)); err != nil {
...
func (p *BusinessUserAttributes) writeField5(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetLinkedInProfileUrl() {
    if err := oprot.WriteFieldBegin(ctx, "linkedInProfileUrl", thrift.STRING, 5); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 5:linkedInProfileUrl: ", p), err) }
    if err := oprot.WriteString(ctx, string(*p.LinkedInProfileUrl)); err != nil {
...
func (p *BusinessUserAttributes) writeField6(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetWorkPhone() {
    if err := oprot.WriteFieldBegin(ctx, "workPhone", thrift.STRING, 6); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 6:workPhone: ", p), err) }
    if err := oprot.WriteString(ctx, string(*p.WorkPhone)); err != nil {
...
func (p *BusinessUserAttributes) writeField7(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetCompanyStartDate() {
    if err := oprot.WriteFieldBegin(ctx, "companyStartDate", thrift.I64, 7); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 7:companyStartDate: ", p), err) }
    if err := oprot.WriteI64(ctx, int64(*p.CompanyStartDate)); err != nil {
...
func (p *BusinessUserAttributes) Equals(other *BusinessUserAttributes) bool {
  if p == other {
    return true
  } else if p == nil || other == nil {
    return false
  ...
  if p.Department != other.Department {
    if p.Department == nil || other.Department == nil {
      return false
    }
    if (*p.Department) != (*other.Department) { return false }
  }
  if p.MobilePhone != other.MobilePhone {
    if p.MobilePhone == nil || other.MobilePhone == nil {
      return false
    }
    if (*p.MobilePhone) != (*other.MobilePhone) { return false }
  }
  if p.LinkedInProfileUrl != other.LinkedInProfileUrl {
    if p.LinkedInProfileUrl == nil || other.LinkedInProfileUrl == nil {
      return false
    }
    if (*p.LinkedInProfileUrl) != (*other.LinkedInProfileUrl) { return false }
  }
  if p.WorkPhone != other.WorkPhone {
    if p.WorkPhone == nil || other.WorkPhone == nil {
      return false
    }
    if (*p.WorkPhone) != (*other.WorkPhone) { return false }
  }
  if p.CompanyStartDate != other.CompanyStartDate {
    if p.CompanyStartDate == nil || other.CompanyStartDate == nil {
      return false
    }
    if (*p.CompanyStartDate) != (*other.CompanyStartDate) { return false }
  }
  return true
}
...
func (p *Accounting)  ReadField25(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(ctx); err != nil {
  return thrift.PrependError("error reading field 25: ", err)
} else {
  p.AvailablePoints = &v
...
func (p *Accounting) writeField25(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetAvailablePoints() {
    if err := oprot.WriteFieldBegin(ctx, "availablePoints", thrift.I32, 25); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 25:availablePoints: ", p), err) }
    if err := oprot.WriteI32(ctx, int32(*p.AvailablePoints)); err != nil {
...
func (p *Accounting) Equals(other *Accounting) bool {
  if p == other {
    return true
  } else if p == nil || other == nil {
    return false
  }
  if p.UploadLimitEnd != other.UploadLimitEnd {
    if p.UploadLimitEnd == nil || other.UploadLimitEnd == nil {
      return false
    }
    if (*p.UploadLimitEnd) != (*other.UploadLimitEnd) { return false }
  }
  if p.UploadLimitNextMonth != other.UploadLimitNextMonth {
    if p.UploadLimitNextMonth == nil || other.UploadLimitNextMonth == nil {
      return false
    }
    if (*p.UploadLimitNextMonth) != (*other.UploadLimitNextMonth) { return false }
  }
  if p.PremiumServiceStatus != other.PremiumServiceStatus {
    if p.PremiumServiceStatus == nil || other.PremiumServiceStatus == nil {
      return false
    }
    if (*p.PremiumServiceStatus) != (*other.PremiumServiceStatus) { return false }
  }
  if p.PremiumOrderNumber != other.PremiumOrderNumber {
    if p.PremiumOrderNumber == nil || other.PremiumOrderNumber == nil {
      return false
    }
    if (*p.PremiumOrderNumber) != (*other.PremiumOrderNumber) { return false }
  }
  if p.PremiumCommerceService != other.PremiumCommerceService {
    if p.PremiumCommerceService == nil || other.PremiumCommerceService == nil {
      return false
    }
    if (*p.PremiumCommerceService) != (*other.PremiumCommerceService) { return false }
  }
  if p.PremiumServiceStart != other.PremiumServiceStart {
    if p.PremiumServiceStart == nil || other.PremiumServiceStart == nil {
      return false
    }
    if (*p.PremiumServiceStart) != (*other.PremiumServiceStart) { return false }
  }
  if p.PremiumServiceSKU != other.PremiumServiceSKU {
    if p.PremiumServiceSKU == nil || other.PremiumServiceSKU == nil {
      return false
    }
    if (*p.PremiumServiceSKU) != (*other.PremiumServiceSKU) { return false }
  }
  if p.LastSuccessfulCharge != other.LastSuccessfulCharge {
    if p.LastSuccessfulCharge == nil || other.LastSuccessfulCharge == nil {
      return false
    }
    if (*p.LastSuccessfulCharge) != (*other.LastSuccessfulCharge) { return false }
  }
  if p.LastFailedCharge != other.LastFailedCharge {
    if p.LastFailedCharge == nil || other.LastFailedCharge == nil {
      return false
    }
    if (*p.LastFailedCharge) != (*other.LastFailedCharge) { return false }
  }
  if p.LastFailedChargeReason != other.LastFailedChargeReason {
    if p.LastFailedChargeReason == nil || other.LastFailedChargeReason == nil {
      return false
    }
    if (*p.LastFailedChargeReason) != (*other.LastFailedChargeReason) { return false }
  }
  if p.NextPaymentDue != other.NextPaymentDue {
    if p.NextPaymentDue == nil || other.NextPaymentDue == nil {
      return false
    }
    if (*p.NextPaymentDue) != (*other.NextPaymentDue) { return false }
  }
  if p.PremiumLockUntil != other.PremiumLockUntil {
    if p.PremiumLockUntil == nil || other.PremiumLockUntil == nil {
      return false
    }
    if (*p.PremiumLockUntil) != (*other.PremiumLockUntil) { return false }
  }
  ...
  if p.PremiumSubscriptionNumber != other.PremiumSubscriptionNumber {
    if p.PremiumSubscriptionNumber == nil || other.PremiumSubscriptionNumber == nil {
      return false
    }
    if (*p.PremiumSubscriptionNumber) != (*other.PremiumSubscriptionNumber) { return false }
  }
  if p.LastRequestedCharge != other.LastRequestedCharge {
    if p.LastRequestedCharge == nil || other.LastRequestedCharge == nil {
      return false
    }
    if (*p.LastRequestedCharge) != (*other.LastRequestedCharge) { return false }
  }
  if p.Currency != other.Currency {
    if p.Currency == nil || other.Currency == nil {
      return false
    }
    if (*p.Currency) != (*other.Currency) { return false }
  }
  if p.UnitPrice != other.UnitPrice {
    if p.UnitPrice == nil || other.UnitPrice == nil {
      return false
    }
    if (*p.UnitPrice) != (*other.UnitPrice) { return false }
  }
  if p.BusinessId != other.BusinessId {
    if p.BusinessId == nil || other.BusinessId == nil {
      return false
    }
    if (*p.BusinessId) != (*other.BusinessId) { return false }
  }
  if p.BusinessName != other.BusinessName {
    if p.BusinessName == nil || other.BusinessName == nil {
      return false
    }
    if (*p.BusinessName) != (*other.BusinessName) { return false }
  }
  if p.BusinessRole != other.BusinessRole {
    if p.BusinessRole == nil || other.BusinessRole == nil {
      return false
    }
    if (*p.BusinessRole) != (*other.BusinessRole) { return false }
  }
  if p.UnitDiscount != other.UnitDiscount {
    if p.UnitDiscount == nil || other.UnitDiscount == nil {
      return false
    }
    if (*p.UnitDiscount) != (*other.UnitDiscount) { return false }
  }
  if p.NextChargeDate != other.NextChargeDate {
    if p.NextChargeDate == nil || other.NextChargeDate == nil {
      return false
    }
    if (*p.NextChargeDate) != (*other.NextChargeDate) { return false }
  }
  if p.AvailablePoints != other.AvailablePoints {
    if p.AvailablePoints == nil || other.AvailablePoints == nil {
      return false
    }
    if (*p.AvailablePoints) != (*other.AvailablePoints) { return false }
  }
  return true
}
...
func (p *BusinessUserInfo)  ReadField5(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(ctx); err != nil {
  return thrift.PrependError("error reading field 5: ", err)
} else {
  temp := Timestamp(v)
...
func (p *BusinessUserInfo) writeField5(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetUpdated() {
    if err := oprot.WriteFieldBegin(ctx, "updated", thrift.I64, 5); err != nil {
...
func (p *BusinessUserInfo) Equals(other *BusinessUserInfo) bool {
  if p == other {
    return true
  } else if p == nil || other == nil {
    return false
...
func (p *AccountLimits) Read(ctx context.Context, iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(ctx); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *AccountLimits)  ReadField1(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(ctx); err != nil {
  return thrift.PrependError("error reading field 1: ", err)
} else {
...
func (p *AccountLimits)  ReadField2(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(ctx); err != nil {
  return thrift.PrependError("error reading field 2: ", err)
} else {
  p.NoteSizeMax = &v
...
func (p *AccountLimits)  ReadField3(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(ctx); err != nil {
  return thrift.PrependError("error reading field 3: ", err)
} else {
  p.ResourceSizeMax = &v
...
func (p *AccountLimits)  ReadField4(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(ctx); err != nil {
  return thrift.PrependError("error reading field 4: ", err)
} else {
...
func (p *AccountLimits)  ReadField5(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(ctx); err != nil {
  return thrift.PrependError("error reading field 5: ", err)
} else {
  p.UploadLimit = &v
...
func (p *AccountLimits)  ReadField6(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(ctx); err != nil {
  return thrift.PrependError("error reading field 6: ", err)
} else {
...
func (p *AccountLimits)  ReadField7(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(ctx); err != nil {
  return thrift.PrependError("error reading field 7: ", err)
} else {
...
func (p *AccountLimits)  ReadField8(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(ctx); err != nil {
  return thrift.PrependError("error reading field 8: ", err)
} else {
  p.UserTagCountMax = &v
...
func (p *AccountLimits)  ReadField9(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(ctx); err != nil {
  return thrift.PrependError("error reading field 9: ", err)
} else {
  p.NoteTagCountMax = &v
...
func (p *AccountLimits)  ReadField10(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(ctx); err != nil {
  return thrift.PrependError("error reading field 10: ", err)
} else {
...
func (p *AccountLimits)  ReadField11(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(ctx); err != nil {
  return thrift.PrependError("error reading field 11: ", err)
} else {
...
func (p *AccountLimits) Write(ctx context.Context, oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin(ctx, "AccountLimits"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if p != nil {
    if err := p.writeField1(ctx, oprot); err != nil { return err }
    if err := p.writeField2(ctx, oprot); err != nil { return err }
...
func (p *AccountLimits) writeField1(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetUserMailLimitDaily() {
    if err := oprot.WriteFieldBegin(ctx, "userMailLimitDaily", thrift.I32, 1); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:userMailLimitDaily: ", p), err) }
    if err := oprot.WriteI32(ctx, int32(*p.UserMailLimitDaily)); err != nil {
...
func (p *AccountLimits) writeField2(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetNoteSizeMax() {
    if err := oprot.WriteFieldBegin(ctx, "noteSizeMax", thrift.I64, 2); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 2:noteSizeMax: ", p), err) }
    if err := oprot.WriteI64(ctx, int64(*p.NoteSizeMax)); err != nil {
...
func (p *AccountLimits) writeField3(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetResourceSizeMax() {
    if err := oprot.WriteFieldBegin(ctx, "resourceSizeMax", thrift.I64, 3); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 3:resourceSizeMax: ", p), err) }
    if err := oprot.WriteI64(ctx, int64(*p.ResourceSizeMax)); err != nil {
...
func (p *AccountLimits) writeField4(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetUserLinkedNotebookMax() {
    if err := oprot.WriteFieldBegin(ctx, "userLinkedNotebookMax", thrift.I32, 4); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 4:userLinkedNotebookMax: ", p), err) }
    if err := oprot.WriteI32(ctx, int32(*p.UserLinkedNotebookMax)); err != nil {
...
func (p *AccountLimits) writeField5(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetUploadLimit() {
    if err := oprot.WriteFieldBegin(ctx, "uploadLimit", thrift.I64, 5); err != nil {
...
func (p *AccountLimits) writeField6(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetUserNoteCountMax() {
    if err := oprot.WriteFieldBegin(ctx, "userNoteCountMax", thrift.I32, 6); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 6:userNoteCountMax: ", p), err) }
    if err := oprot.WriteI32(ctx, int32(*p.UserNoteCountMax)); err != nil {
...
func (p *AccountLimits) writeField7(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetUserNotebookCountMax() {
    if err := oprot.WriteFieldBegin(ctx, "userNotebookCountMax", thrift.I32, 7); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 7:userNotebookCountMax: ", p), err) }
    if err := oprot.WriteI32(ctx, int32(*p.UserNotebookCountMax)); err != nil {
...
func (p *AccountLimits) writeField8(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetUserTagCountMax() {
    if err := oprot.WriteFieldBegin(ctx, "userTagCountMax", thrift.I32, 8); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 8:userTagCountMax: ", p), err) }
    if err := oprot.WriteI32(ctx, int32(*p.UserTagCountMax)); err != nil {
...
func (p *AccountLimits) writeField9(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetNoteTagCountMax() {
    if err := oprot.WriteFieldBegin(ctx, "noteTagCountMax", thrift.I32, 9); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 9:noteTagCountMax: ", p), err) }
    if err := oprot.WriteI32(ctx, int32(*p.NoteTagCountMax)); err != nil {
...
func (p *AccountLimits) writeField10(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetUserSavedSearchesMax() {
    if err := oprot.WriteFieldBegin(ctx, "userSavedSearchesMax", thrift.I32, 10); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 10:userSavedSearchesMax: ", p), err) }
    if err := oprot.WriteI32(ctx, int32(*p.UserSavedSearchesMax)); err != nil {
...
func (p *AccountLimits) writeField11(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetNoteResourceCountMax() {
    if err := oprot.WriteFieldBegin(ctx, "noteResourceCountMax", thrift.I32, 11); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 11:noteResourceCountMax: ", p), err) }
    if err := oprot.WriteI32(ctx, int32(*p.NoteResourceCountMax)); err != nil {
...
func (p *AccountLimits) Equals(other *AccountLimits) bool {
  if p == other {
    return true
  } else if p == nil || other == nil {
    return false
  }
  if p.UserMailLimitDaily != other.UserMailLimitDaily {
    if p.UserMailLimitDaily == nil || other.UserMailLimitDaily == nil {
      return false
    }
    if (*p.UserMailLimitDaily) != (*other.UserMailLimitDaily) { return false }
  }
  if p.NoteSizeMax != other.NoteSizeMax {
    if p.NoteSizeMax == nil || other.NoteSizeMax == nil {
      return false
    }
    if (*p.NoteSizeMax) != (*other.NoteSizeMax) { return false }
  }
  if p.ResourceSizeMax != other.ResourceSizeMax {
    if p.ResourceSizeMax == nil || other.ResourceSizeMax == nil {
      return false
    }
    if (*p.ResourceSizeMax) != (*other.ResourceSizeMax) { return false }
  }
  if p.UserLinkedNotebookMax != other.UserLinkedNotebookMax {
    if p.UserLinkedNotebookMax == nil || other.UserLinkedNotebookMax == nil {
      return false
    }
    if (*p.UserLinkedNotebookMax) != (*other.UserLinkedNotebookMax) { return false }
  }
  if p.UploadLimit != other.UploadLimit {
    if p.UploadLimit == nil || other.UploadLimit == nil {
      return false
    }
    if (*p.UploadLimit) != (*other.UploadLimit) { return false }
  }
  if p.UserNoteCountMax != other.UserNoteCountMax {
    if p.UserNoteCountMax == nil || other.UserNoteCountMax == nil {
      return false
    }
    if (*p.UserNoteCountMax) != (*other.UserNoteCountMax) { return false }
  }
  if p.UserNotebookCountMax != other.UserNotebookCountMax {
    if p.UserNotebookCountMax == nil || other.UserNotebookCountMax == nil {
      return false
    }
    if (*p.UserNotebookCountMax) != (*other.UserNotebookCountMax) { return false }
  }
  if p.UserTagCountMax != other.UserTagCountMax {
    if p.UserTagCountMax == nil || other.UserTagCountMax == nil {
      return false
    }
    if (*p.UserTagCountMax) != (*other.UserTagCountMax) { return false }
  }
  if p.NoteTagCountMax != other.NoteTagCountMax {
    if p.NoteTagCountMax == nil || other.NoteTagCountMax == nil {
      return false
    }
    if (*p.NoteTagCountMax) != (*other.NoteTagCountMax) { return false }
  }
  if p.UserSavedSearchesMax != other.UserSavedSearchesMax {
    if p.UserSavedSearchesMax == nil || other.UserSavedSearchesMax == nil {
      return false
    }
    if (*p.UserSavedSearchesMax) != (*other.UserSavedSearchesMax) { return false }
  }
  if p.NoteResourceCountMax != other.NoteResourceCountMax {
    if p.NoteResourceCountMax == nil || other.NoteResourceCountMax == nil {
      return false
    }
    if (*p.NoteResourceCountMax) != (*other.NoteResourceCountMax) { return false }
  }
  return true
}
...
func (p *User)  ReadField21(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(ctx); err != nil {
  return thrift.PrependError("error reading field 21: ", err)
} else {
  temp := ServiceLevel(v)
...
func (p *User)  ReadField19(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(ctx); err != nil {
  return thrift.PrependError("error reading field 19: ", err)
} else {
  p.PhotoUrl = &v
...
func (p *User)  ReadField20(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(ctx); err != nil {
  return thrift.PrependError("error reading field 20: ", err)
} else {
  temp := Timestamp(v)
...
func (p *User)  ReadField22(ctx context.Context, iprot thrift.TProtocol) error {
  p.AccountLimits = &AccountLimits{}
  if err := p.AccountLimits.Read(ctx, iprot); err != nil {
...
func (p *User) writeField19(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetPhotoUrl() {
    if err := oprot.WriteFieldBegin(ctx, "photoUrl", thrift.STRING, 19); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 19:photoUrl: ", p), err) }
    if err := oprot.WriteString(ctx, string(*p.PhotoUrl)); err != nil {
...
func (p *User) writeField20(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetPhotoLastUpdated() {
    if err := oprot.WriteFieldBegin(ctx, "photoLastUpdated", thrift.I64, 20); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 20:photoLastUpdated: ", p), err) }
    if err := oprot.WriteI64(ctx, int64(*p.PhotoLastUpdated)); err != nil {
...
func (p *User) writeField21(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetServiceLevel() {
    if err := oprot.WriteFieldBegin(ctx, "serviceLevel", thrift.I32, 21); err != nil {
...
func (p *User) writeField22(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetAccountLimits() {
    if err := oprot.WriteFieldBegin(ctx, "accountLimits", thrift.STRUCT, 22); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 22:accountLimits: ", p), err) }
    if err := p.AccountLimits.Write(ctx, oprot); err != nil {
...
func (p *User) Equals(other *User) bool {
  ...
  if p.Active != other.Active {
    if p.Active == nil || other.Active == nil {
      return false
    }
    if (*p.Active) != (*other.Active) { return false }
  }
  if p.ShardId != other.ShardId {
    if p.ShardId == nil || other.ShardId == nil {
      return false
    }
    if (*p.ShardId) != (*other.ShardId) { return false }
  }
  if !p.Attributes.Equals(other.Attributes) { return false }
  if !p.Accounting.Equals(other.Accounting) { return false }
  if !p.BusinessUserInfo.Equals(other.BusinessUserInfo) { return false }
  if p.PhotoUrl != other.PhotoUrl {
    if p.PhotoUrl == nil || other.PhotoUrl == nil {
      return false
    }
    if (*p.PhotoUrl) != (*other.PhotoUrl) { return false }
  }
  if p.PhotoLastUpdated != other.PhotoLastUpdated {
    if p.PhotoLastUpdated == nil || other.PhotoLastUpdated == nil {
      return false
    }
    if (*p.PhotoLastUpdated) != (*other.PhotoLastUpdated) { return false }
  }
  ...
  if !p.AccountLimits.Equals(other.AccountLimits) { return false }
  return true
}
...
func (p *Contact)  ReadField3(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(ctx); err != nil {
  return thrift.PrependError("error reading field 3: ", err)
} else {
  temp := ContactType(v)
...
func (p *Contact)  ReadField4(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(ctx); err != nil {
  return thrift.PrependError("error reading field 4: ", err)
} else {
  p.PhotoUrl = &v
...
func (p *Contact)  ReadField5(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(ctx); err != nil {
  return thrift.PrependError("error reading field 5: ", err)
} else {
  temp := Timestamp(v)
...
func (p *Contact)  ReadField6(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadBinary(ctx); err != nil {
  return thrift.PrependError("error reading field 6: ", err)
} else {
  p.MessagingPermit = v
...
func (p *Contact)  ReadField7(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(ctx); err != nil {
  return thrift.PrependError("error reading field 7: ", err)
} else {
  temp := Timestamp(v)
...
func (p *Contact) writeField3(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetType() {
...
func (p *Contact) writeField4(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetPhotoUrl() {
    if err := oprot.WriteFieldBegin(ctx, "photoUrl", thrift.STRING, 4); err != nil {
...
func (p *Contact) writeField5(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetPhotoLastUpdated() {
    if err := oprot.WriteFieldBegin(ctx, "photoLastUpdated", thrift.I64, 5); err != nil {
...
func (p *Contact) writeField6(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetMessagingPermit() {
    if err := oprot.WriteFieldBegin(ctx, "messagingPermit", thrift.STRING, 6); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 6:messagingPermit: ", p), err) }
    if err := oprot.WriteBinary(ctx, p.MessagingPermit); err != nil {
...
func (p *Contact) writeField7(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetMessagingPermitExpires() {
    if err := oprot.WriteFieldBegin(ctx, "messagingPermitExpires", thrift.I64, 7); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 7:messagingPermitExpires: ", p), err) }
    if err := oprot.WriteI64(ctx, int64(*p.MessagingPermitExpires)); err != nil {
...
func (p *Contact) Equals(other *Contact) bool {
  ...
  if bytes.Compare(p.MessagingPermit, other.MessagingPermit) != 0 { return false }
  if p.MessagingPermitExpires != other.MessagingPermitExpires {
    if p.MessagingPermitExpires == nil || other.MessagingPermitExpires == nil {
      return false
    }
    if (*p.MessagingPermitExpires) != (*other.MessagingPermitExpires) { return false }
  }
  return true
}
...
func (p *Identity)  ReadField1(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(ctx); err != nil {
  return thrift.PrependError("error reading field 1: ", err)
} else {
  temp := IdentityID(v)
...
func (p *Identity)  ReadField3(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(ctx); err != nil {
  return thrift.PrependError("error reading field 3: ", err)
} else {
  temp := UserID(v)
...
func (p *Identity)  ReadField4(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadBool(ctx); err != nil {
  return thrift.PrependError("error reading field 4: ", err)
} else {
  p.Deactivated = &v
...
func (p *Identity)  ReadField5(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadBool(ctx); err != nil {
  return thrift.PrependError("error reading field 5: ", err)
} else {
  p.SameBusiness = &v
...
func (p *Identity)  ReadField6(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadBool(ctx); err != nil {
  return thrift.PrependError("error reading field 6: ", err)
} else {
  p.Blocked = &v
...
func (p *Identity)  ReadField7(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadBool(ctx); err != nil {
  return thrift.PrependError("error reading field 7: ", err)
} else {
  p.UserConnected = &v
...
func (p *Identity)  ReadField8(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(ctx); err != nil {
  return thrift.PrependError("error reading field 8: ", err)
} else {
...
func (p *Identity) writeField1(ctx context.Context, oprot thrift.TProtocol) (err error) {
...
func (p *Identity) writeField2(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetContact() {
    if err := oprot.WriteFieldBegin(ctx, "contact", thrift.STRUCT, 2); err != nil {
...
func (p *Identity) writeField3(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetUserId() {
    if err := oprot.WriteFieldBegin(ctx, "userId", thrift.I32, 3); err != nil {
...
func (p *Identity) writeField4(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetDeactivated() {
    if err := oprot.WriteFieldBegin(ctx, "deactivated", thrift.BOOL, 4); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 4:deactivated: ", p), err) }
    if err := oprot.WriteBool(ctx, bool(*p.Deactivated)); err != nil {
...
func (p *Identity) writeField5(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetSameBusiness() {
    if err := oprot.WriteFieldBegin(ctx, "sameBusiness", thrift.BOOL, 5); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 5:sameBusiness: ", p), err) }
    if err := oprot.WriteBool(ctx, bool(*p.SameBusiness)); err != nil {
...
func (p *Identity) writeField6(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetBlocked() {
    if err := oprot.WriteFieldBegin(ctx, "blocked", thrift.BOOL, 6); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 6:blocked: ", p), err) }
    if err := oprot.WriteBool(ctx, bool(*p.Blocked)); err != nil {
...
func (p *Identity) writeField7(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetUserConnected() {
    if err := oprot.WriteFieldBegin(ctx, "userConnected", thrift.BOOL, 7); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 7:userConnected: ", p), err) }
    if err := oprot.WriteBool(ctx, bool(*p.UserConnected)); err != nil {
...
func (p *Identity) writeField8(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetEventId() {
    if err := oprot.WriteFieldBegin(ctx, "eventId", thrift.I64, 8); err != nil {
...
func (p *Identity) Equals(other *Identity) bool {
  ...
  if p.Deactivated != other.Deactivated {
    if p.Deactivated == nil || other.Deactivated == nil {
      return false
    }
    if (*p.Deactivated) != (*other.Deactivated) { return false }
  }
  if p.SameBusiness != other.SameBusiness {
    if p.SameBusiness == nil || other.SameBusiness == nil {
      return false
    }
    if (*p.SameBusiness) != (*other.SameBusiness) { return false }
  }
  if p.Blocked != other.Blocked {
    if p.Blocked == nil || other.Blocked == nil {
      return false
    }
    if (*p.Blocked) != (*other.Blocked) { return false }
  }
  if p.UserConnected != other.UserConnected {
    if p.UserConnected == nil || other.UserConnected == nil {
      return false
    }
    if (*p.UserConnected) != (*other.UserConnected) { return false }
  }
  if p.EventId != other.EventId {
    if p.EventId == nil || other.EventId == nil {
      return false
    }
...
func (p *Tag) Equals(other *Tag) bool {
  ...
  if p.ParentGuid != other.ParentGuid {
    if p.ParentGuid == nil || other.ParentGuid == nil {
      return false
    }
    if (*p.ParentGuid) != (*other.ParentGuid) { return false }
  }
...
var _elem4 string
    ...
    p.KeysOnly = append(p.KeysOnly, _elem4)
  }
    ...
    for i := 0; i<len(p.KeysOnly); i++ {
      for j := i+1; j<len(p.KeysOnly); j++ {
        if func(tgt, src string) bool {
          ...
          return true
        }(p.KeysOnly[i], p.KeysOnly[j]) {
          return thrift.PrependError("", fmt.Errorf("%T error writing set field: slice is not unique", p.KeysOnly))
        }
      }
    }
...
func (p *LazyMap) Equals(other *LazyMap) bool {
  if p == other {
    return true
  } else if p == nil || other == nil {
    return false
  }
  if len(p.KeysOnly) != len(other.KeysOnly) { return false }
  for i, _tgt := range p.KeysOnly {
    _src7 := other.KeysOnly[i]
    if _tgt != _src7 { return false }
  }
  if len(p.FullMap) != len(other.FullMap) { return false }
  for k, _tgt := range p.FullMap {
    _src8 := other.FullMap[k]
...
func (p *ResourceAttributes) Equals(other *ResourceAttributes) bool {
  if p == other {
    return true
  } else if p == nil || other == nil {
    return false
  }
  if p.SourceURL != other.SourceURL {
    if p.SourceURL == nil || other.SourceURL == nil {
      return false
    }
    if (*p.SourceURL) != (*other.SourceURL) { return false }
  }
  ...
  if p.Latitude != other.Latitude {
    if p.Latitude == nil || other.Latitude == nil {
      return false
    }
    if (*p.Latitude) != (*other.Latitude) { return false }
  }
  if p.Longitude != other.Longitude {
    if p.Longitude == nil || other.Longitude == nil {
      return false
    }
    if (*p.Longitude) != (*other.Longitude) { return false }
  }
  if p.Altitude != other.Altitude {
    if p.Altitude == nil || other.Altitude == nil {
      return false
    }
    if (*p.Altitude) != (*other.Altitude) { return false }
  }
  if p.CameraMake != other.CameraMake {
    if p.CameraMake == nil || other.CameraMake == nil {
      return false
    }
    if (*p.CameraMake) != (*other.CameraMake) { return false }
  }
  if p.CameraModel != other.CameraModel {
    if p.CameraModel == nil || other.CameraModel == nil {
      return false
    }
    if (*p.CameraModel) != (*other.CameraModel) { return false }
  }
  if p.ClientWillIndex != other.ClientWillIndex {
    if p.ClientWillIndex == nil || other.ClientWillIndex == nil {
      return false
    }
    if (*p.ClientWillIndex) != (*other.ClientWillIndex) { return false }
  }
  if p.RecoType != other.RecoType {
    if p.RecoType == nil || other.RecoType == nil {
      return false
    }
    if (*p.RecoType) != (*other.RecoType) { return false }
  }
  ...
  if p.Attachment != other.Attachment {
    if p.Attachment == nil || other.Attachment == nil {
      return false
    }
    if (*p.Attachment) != (*other.Attachment) { return false }
  }
  if !p.ApplicationData.Equals(other.ApplicationData) { return false }
  return true
}
...
func (p *Resource) Equals(other *Resource) bool {
  ...
  if p.Mime != other.Mime {
    if p.Mime == nil || other.Mime == nil {
      return false
    }
    if (*p.Mime) != (*other.Mime) { return false }
  }
  ...
  if !p.Recognition.Equals(other.Recognition) { return false }
  if !p.Attributes.Equals(other.Attributes) { return false }
  if p.UpdateSequenceNum != other.UpdateSequenceNum {
    if p.UpdateSequenceNum == nil || other.UpdateSequenceNum == nil {
      return false
  ...
  if !p.AlternateData.Equals(other.AlternateData) { return false }
  return true
}
...
var _val10 string
    ...
    p.Classifications[_key9] = _val10
  }
  if err := iprot.ReadMapEnd(ctx); err != nil {
    return thrift.PrependError("error reading map end: ", err)
  }
...
func (p *NoteAttributes)  ReadField29(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadBool(ctx); err != nil {
  return thrift.PrependError("error reading field 29: ", err)
} else {
...
func (p *NoteAttributes)  ReadField30(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(ctx); err != nil {
  return thrift.PrependError("error reading field 30: ", err)
} else {
  temp := GUID(v)
...
func (p *NoteAttributes)  ReadField31(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(ctx); err != nil {
  return thrift.PrependError("error reading field 31: ", err)
} else {
...
func (p *NoteAttributes) writeField29(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetSharedWithBusiness() {
    if err := oprot.WriteFieldBegin(ctx, "sharedWithBusiness", thrift.BOOL, 29); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 29:sharedWithBusiness: ", p), err) }
    if err := oprot.WriteBool(ctx, bool(*p.SharedWithBusiness)); err != nil {
...
func (p *NoteAttributes) writeField30(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetConflictSourceNoteGuid() {
    if err := oprot.WriteFieldBegin(ctx, "conflictSourceNoteGuid", thrift.STRING, 30); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 30:conflictSourceNoteGuid: ", p), err) }
    if err := oprot.WriteString(ctx, string(*p.ConflictSourceNoteGuid)); err != nil {
...
func (p *NoteAttributes) writeField31(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetNoteTitleQuality() {
    if err := oprot.WriteFieldBegin(ctx, "noteTitleQuality", thrift.I32, 31); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 31:noteTitleQuality: ", p), err) }
    if err := oprot.WriteI32(ctx, int32(*p.NoteTitleQuality)); err != nil {
...
func (p *NoteAttributes) Equals(other *NoteAttributes) bool {
  if p == other {
    return true
  } else if p == nil || other == nil {
    return false
  }
  if p.SubjectDate != other.SubjectDate {
    if p.SubjectDate == nil || other.SubjectDate == nil {
      return false
    }
    if (*p.SubjectDate) != (*other.SubjectDate) { return false }
  }
  if p.Latitude != other.Latitude {
    if p.Latitude == nil || other.Latitude == nil {
      return false
  ...
  if p.SourceApplication != other.SourceApplication {
    if p.SourceApplication == nil || other.SourceApplication == nil {
      return false
    }
    if (*p.SourceApplication) != (*other.SourceApplication) { return false }
  }
  if p.ShareDate != other.ShareDate {
    if p.ShareDate == nil || other.ShareDate == nil {
      return false
    }
    if (*p.ShareDate) != (*other.ShareDate) { return false }
  }
  if p.ReminderOrder != other.ReminderOrder {
    if p.ReminderOrder == nil || other.ReminderOrder == nil {
      return false
    }
    if (*p.ReminderOrder) != (*other.ReminderOrder) { return false }
  }
  if p.ReminderDoneTime != other.ReminderDoneTime {
    if p.ReminderDoneTime == nil || other.ReminderDoneTime == nil {
      return false
    }
    if (*p.ReminderDoneTime) != (*other.ReminderDoneTime) { return false }
  }
  if p.ReminderTime != other.ReminderTime {
    if p.ReminderTime == nil || other.ReminderTime == nil {
      return false
    }
    if (*p.ReminderTime) != (*other.ReminderTime) { return false }
  }
  if p.PlaceName != other.PlaceName {
    if p.PlaceName == nil || other.PlaceName == nil {
      return false
    }
    if (*p.PlaceName) != (*other.PlaceName) { return false }
  }
  if p.ContentClass != other.ContentClass {
    if p.ContentClass == nil || other.ContentClass == nil {
      return false
    }
    if (*p.ContentClass) != (*other.ContentClass) { return false }
  }
  if !p.ApplicationData.Equals(other.ApplicationData) { return false }
  if p.LastEditedBy != other.LastEditedBy {
    if p.LastEditedBy == nil || other.LastEditedBy == nil {
      return false
    }
    if (*p.LastEditedBy) != (*other.LastEditedBy) { return false }
  }
  if len(p.Classifications) != len(other.Classifications) { return false }
  for k, _tgt := range p.Classifications {
    _src11 := other.Classifications[k]
  ...
  if p.SharedWithBusiness != other.SharedWithBusiness {
    if p.SharedWithBusiness == nil || other.SharedWithBusiness == nil {
      return false
    }
    if (*p.SharedWithBusiness) != (*other.SharedWithBusiness) { return false }
  }
  if p.ConflictSourceNoteGuid != other.ConflictSourceNoteGuid {
    if p.ConflictSourceNoteGuid == nil || other.ConflictSourceNoteGuid == nil {
      return false
    }
    if (*p.ConflictSourceNoteGuid) != (*other.ConflictSourceNoteGuid) { return false }
  }
  if p.NoteTitleQuality != other.NoteTitleQuality {
    if p.NoteTitleQuality == nil || other.NoteTitleQuality == nil {
      return false
    }
    if (*p.NoteTitleQuality) != (*other.NoteTitleQuality) { return false }
  }
  return true
}
...
func (p *SharedNote) Read(ctx context.Context, iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(ctx); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *SharedNote)  ReadField1(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(ctx); err != nil {
  return thrift.PrependError("error reading field 1: ", err)
} else {
  temp := UserID(v)
...
func (p *SharedNote)  ReadField2(ctx context.Context, iprot thrift.TProtocol) error {
  p.RecipientIdentity = &Identity{}
  if err := p.RecipientIdentity.Read(ctx, iprot); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.RecipientIdentity), err)
  }
  return nil
}

func (p *SharedNote)  ReadField3(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(ctx); err != nil {
  return thrift.PrependError("error reading field 3: ", err)
} else {
...
func (p *SharedNote)  ReadField4(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(ctx); err != nil {
  return thrift.PrependError("error reading field 4: ", err)
} else {
  temp := Timestamp(v)
...
func (p *SharedNote)  ReadField5(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(ctx); err != nil {
  return thrift.PrependError("error reading field 5: ", err)
} else {
  temp := Timestamp(v)
...
func (p *SharedNote)  ReadField6(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(ctx); err != nil {
  return thrift.PrependError("error reading field 6: ", err)
} else {
  temp := Timestamp(v)
...
func (p *SharedNote) Write(ctx context.Context, oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin(ctx, "SharedNote"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if p != nil {
    if err := p.writeField1(ctx, oprot); err != nil { return err }
    if err := p.writeField2(ctx, oprot); err != nil { return err }
...
func (p *SharedNote) writeField1(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetSharerUserID() {
    if err := oprot.WriteFieldBegin(ctx, "sharerUserID", thrift.I32, 1); err != nil {
...
func (p *SharedNote) writeField2(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetRecipientIdentity() {
    if err := oprot.WriteFieldBegin(ctx, "recipientIdentity", thrift.STRUCT, 2); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 2:recipientIdentity: ", p), err) }
    if err := p.RecipientIdentity.Write(ctx, oprot); err != nil {
...
func (p *SharedNote) writeField3(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetPrivilege() {
...
func (p *SharedNote) writeField4(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetServiceCreated() {
    if err := oprot.WriteFieldBegin(ctx, "serviceCreated", thrift.I64, 4); err != nil {
...
func (p *SharedNote) writeField5(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetServiceUpdated() {
    if err := oprot.WriteFieldBegin(ctx, "serviceUpdated", thrift.I64, 5); err != nil {
...
func (p *SharedNote) writeField6(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetServiceAssigned() {
    if err := oprot.WriteFieldBegin(ctx, "serviceAssigned", thrift.I64, 6); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 6:serviceAssigned: ", p), err) }
    if err := oprot.WriteI64(ctx, int64(*p.ServiceAssigned)); err != nil {
...
func (p *SharedNote) Equals(other *SharedNote) bool {
  if p == other {
    return true
  } else if p == nil || other == nil {
    return false
  ...
  if !p.RecipientIdentity.Equals(other.RecipientIdentity) { return false }
  if p.Privilege != other.Privilege {
    if p.Privilege == nil || other.Privilege == nil {
      return false
    }
  ...
  if p.ServiceCreated != other.ServiceCreated {
    if p.ServiceCreated == nil || other.ServiceCreated == nil {
      return false
    }
    if (*p.ServiceCreated) != (*other.ServiceCreated) { return false }
  }
  if p.ServiceUpdated != other.ServiceUpdated {
    if p.ServiceUpdated == nil || other.ServiceUpdated == nil {
      return false
    }
    if (*p.ServiceUpdated) != (*other.ServiceUpdated) { return false }
  }
  if p.ServiceAssigned != other.ServiceAssigned {
    if p.ServiceAssigned == nil || other.ServiceAssigned == nil {
      return false
    }
    if (*p.ServiceAssigned) != (*other.ServiceAssigned) { return false }
  }
  return true
}
...
func (p *NoteRestrictions) Read(ctx context.Context, iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(ctx); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *NoteRestrictions)  ReadField1(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadBool(ctx); err != nil {
  return thrift.PrependError("error reading field 1: ", err)
} else {
  p.NoUpdateTitle = &v
...
func (p *NoteRestrictions)  ReadField2(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadBool(ctx); err != nil {
  return thrift.PrependError("error reading field 2: ", err)
} else {
  p.NoUpdateContent = &v
...
func (p *NoteRestrictions)  ReadField3(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadBool(ctx); err != nil {
  return thrift.PrependError("error reading field 3: ", err)
} else {
  p.NoEmail = &v
...
func (p *NoteRestrictions)  ReadField4(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadBool(ctx); err != nil {
  return thrift.PrependError("error reading field 4: ", err)
} else {
  p.NoShare = &v
...
func (p *NoteRestrictions)  ReadField5(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadBool(ctx); err != nil {
  return thrift.PrependError("error reading field 5: ", err)
} else {
  p.NoSharePublicly = &v
...
func (p *NoteRestrictions) Write(ctx context.Context, oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin(ctx, "NoteRestrictions"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if p != nil {
    if err := p.writeField1(ctx, oprot); err != nil { return err }
    if err := p.writeField2(ctx, oprot); err != nil { return err }
...
func (p *NoteRestrictions) writeField1(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetNoUpdateTitle() {
    if err := oprot.WriteFieldBegin(ctx, "noUpdateTitle", thrift.BOOL, 1); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:noUpdateTitle: ", p), err) }
    if err := oprot.WriteBool(ctx, bool(*p.NoUpdateTitle)); err != nil {
...
func (p *NoteRestrictions) writeField2(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetNoUpdateContent() {
    if err := oprot.WriteFieldBegin(ctx, "noUpdateContent", thrift.BOOL, 2); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 2:noUpdateContent: ", p), err) }
    if err := oprot.WriteBool(ctx, bool(*p.NoUpdateContent)); err != nil {
...
func (p *NoteRestrictions) writeField3(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetNoEmail() {
    if err := oprot.WriteFieldBegin(ctx, "noEmail", thrift.BOOL, 3); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 3:noEmail: ", p), err) }
    if err := oprot.WriteBool(ctx, bool(*p.NoEmail)); err != nil {
...
func (p *NoteRestrictions) writeField4(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetNoShare() {
    if err := oprot.WriteFieldBegin(ctx, "noShare", thrift.BOOL, 4); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 4:noShare: ", p), err) }
    if err := oprot.WriteBool(ctx, bool(*p.NoShare)); err != nil {
...
func (p *NoteRestrictions) writeField5(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetNoSharePublicly() {
    if err := oprot.WriteFieldBegin(ctx, "noSharePublicly", thrift.BOOL, 5); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 5:noSharePublicly: ", p), err) }
    if err := oprot.WriteBool(ctx, bool(*p.NoSharePublicly)); err != nil {
...
func (p *NoteRestrictions) Equals(other *NoteRestrictions) bool {
  if p == other {
    return true
  } else if p == nil || other == nil {
    return false
  }
  if p.NoUpdateTitle != other.NoUpdateTitle {
    if p.NoUpdateTitle == nil || other.NoUpdateTitle == nil {
      return false
    }
    if (*p.NoUpdateTitle) != (*other.NoUpdateTitle) { return false }
  }
  if p.NoUpdateContent != other.NoUpdateContent {
    if p.NoUpdateContent == nil || other.NoUpdateContent == nil {
      return false
    }
    if (*p.NoUpdateContent) != (*other.NoUpdateContent) { return false }
  }
  if p.NoEmail != other.NoEmail {
    if p.NoEmail == nil || other.NoEmail == nil {
      return false
    }
    if (*p.NoEmail) != (*other.NoEmail) { return false }
  }
  if p.NoShare != other.NoShare {
    if p.NoShare == nil || other.NoShare == nil {
      return false
    }
    if (*p.NoShare) != (*other.NoShare) { return false }
  }
  if p.NoSharePublicly != other.NoSharePublicly {
    if p.NoSharePublicly == nil || other.NoSharePublicly == nil {
      return false
    }
    if (*p.NoSharePublicly) != (*other.NoSharePublicly) { return false }
  }
  return true
}
...
func (p *NoteLimits) Read(ctx context.Context, iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(ctx); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *NoteLimits)  ReadField1(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(ctx); err != nil {
  return thrift.PrependError("error reading field 1: ", err)
} else {
  p.NoteResourceCountMax = &v
...
func (p *NoteLimits)  ReadField2(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(ctx); err != nil {
  return thrift.PrependError("error reading field 2: ", err)
} else {
  p.UploadLimit = &v
...
func (p *NoteLimits)  ReadField3(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(ctx); err != nil {
  return thrift.PrependError("error reading field 3: ", err)
} else {
  p.ResourceSizeMax = &v
...
func (p *NoteLimits)  ReadField4(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(ctx); err != nil {
  return thrift.PrependError("error reading field 4: ", err)
} else {
  p.NoteSizeMax = &v
...
func (p *NoteLimits)  ReadField5(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(ctx); err != nil {
  return thrift.PrependError("error reading field 5: ", err)
} else {
  p.Uploaded = &v
...
func (p *NoteLimits) Write(ctx context.Context, oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin(ctx, "NoteLimits"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if p != nil {
    if err := p.writeField1(ctx, oprot); err != nil { return err }
    if err := p.writeField2(ctx, oprot); err != nil { return err }
...
func (p *NoteLimits) writeField1(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetNoteResourceCountMax() {
    if err := oprot.WriteFieldBegin(ctx, "noteResourceCountMax", thrift.I32, 1); err != nil {
...
func (p *NoteLimits) writeField2(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetUploadLimit() {
    if err := oprot.WriteFieldBegin(ctx, "uploadLimit", thrift.I64, 2); err != nil {
...
func (p *NoteLimits) writeField3(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetResourceSizeMax() {
    if err := oprot.WriteFieldBegin(ctx, "resourceSizeMax", thrift.I64, 3); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 3:resourceSizeMax: ", p), err) }
    if err := oprot.WriteI64(ctx, int64(*p.ResourceSizeMax)); err != nil {
...
func (p *NoteLimits) writeField4(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetNoteSizeMax() {
    if err := oprot.WriteFieldBegin(ctx, "noteSizeMax", thrift.I64, 4); err != nil {
...
func (p *NoteLimits) writeField5(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetUploaded() {
    if err := oprot.WriteFieldBegin(ctx, "uploaded", thrift.I64, 5); err != nil {
...
func (p *NoteLimits) Equals(other *NoteLimits) bool {
  if p == other {
    return true
  } else if p == nil || other == nil {
    return false
...
var _elem14 string
    ...
    p.TagNames = append(p.TagNames, _elem14)
  }
  if err := iprot.ReadListEnd(ctx); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *Note)  ReadField16(ctx context.Context, iprot thrift.TProtocol) error {
  _, size, err := iprot.ReadListBegin(ctx)
  if err != nil {
    return thrift.PrependError("error reading list begin: ", err)
  }
  ...
  for i := 0; i < size; i ++ {
    ...
    p.SharedNotes = append(p.SharedNotes, _elem15)
  }
  if err := iprot.ReadListEnd(ctx); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *Note)  ReadField17(ctx context.Context, iprot thrift.TProtocol) error {
...
func (p *Note)  ReadField18(ctx context.Context, iprot thrift.TProtocol) error {
  p.Limits = &NoteLimits{}
  if err := p.Limits.Read(ctx, iprot); err != nil {
...
func (p *Note) writeField4(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetContentHash() {
    if err := oprot.WriteFieldBegin(ctx, "contentHash", thrift.STRING, 4); err != nil {
...
func (p *Note) writeField16(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetSharedNotes() {
    if err := oprot.WriteFieldBegin(ctx, "sharedNotes", thrift.LIST, 16); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 16:sharedNotes: ", p), err) }
    if err := oprot.WriteListBegin(ctx, thrift.STRUCT, len(p.SharedNotes)); err != nil {
      return thrift.PrependError("error writing list begin: ", err)
    }
...
func (p *Note) writeField17(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetRestrictions() {
...
func (p *Note) writeField18(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetLimits() {
    if err := oprot.WriteFieldBegin(ctx, "limits", thrift.STRUCT, 18); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 18:limits: ", p), err) }
    if err := p.Limits.Write(ctx, oprot); err != nil {
...
func (p *Note) Equals(other *Note) bool {
  if p == other {
    return true
  } else if p == nil || other == nil {
    return false
  ...
  if bytes.Compare(p.ContentHash, other.ContentHash) != 0 { return false }
  ...
  for i, _tgt := range p.TagGuids {
    _src16 := other.TagGuids[i]
    if _tgt != _src16 { return false }
  }
  if len(p.Resources) != len(other.Resources) { return false }
  for i, _tgt := range p.Resources {
    _src17 := other.Resources[i]
    if !_tgt.Equals(_src17) { return false }
  }
  if !p.Attributes.Equals(other.Attributes) { return false }
  if len(p.TagNames) != len(other.TagNames) { return false }
  for i, _tgt := range p.TagNames {
    _src18 := other.TagNames[i]
    if _tgt != _src18 { return false }
  }
  if len(p.SharedNotes) != len(other.SharedNotes) { return false }
  for i, _tgt := range p.SharedNotes {
    _src19 := other.SharedNotes[i]
    if !_tgt.Equals(_src19) { return false }
  }
  if !p.Restrictions.Equals(other.Restrictions) { return false }
  if !p.Limits.Equals(other.Limits) { return false }
  return true
}
...
func (p *Publishing) Equals(other *Publishing) bool {
  if p == other {
    return true
  } else if p == nil || other == nil {
    return false
  ...
  if p.PublicDescription != other.PublicDescription {
    if p.PublicDescription == nil || other.PublicDescription == nil {
      return false
    }
    if (*p.PublicDescription) != (*other.PublicDescription) { return false }
  }
  return true
}
...
func (p *BusinessNotebook) Equals(other *BusinessNotebook) bool {
  if p == other {
    return true
  } else if p == nil || other == nil {
    return false
  }
  if p.NotebookDescription != other.NotebookDescription {
    if p.NotebookDescription == nil || other.NotebookDescription == nil {
      return false
    }
    if (*p.NotebookDescription) != (*other.NotebookDescription) { return false }
  }
  if p.Privilege != other.Privilege {
    if p.Privilege == nil || other.Privilege == nil {
      return false
  ...
  if p.Recommended != other.Recommended {
    if p.Recommended == nil || other.Recommended == nil {
      return false
    }
    if (*p.Recommended) != (*other.Recommended) { return false }
  }
  return true
}
...
func (p *SavedSearchScope) Equals(other *SavedSearchScope) bool {
  if p == other {
    return true
  } else if p == nil || other == nil {
    return false
  }
  if p.IncludeAccount != other.IncludeAccount {
    if p.IncludeAccount == nil || other.IncludeAccount == nil {
      return false
    }
    if (*p.IncludeAccount) != (*other.IncludeAccount) { return false }
  }
  if p.IncludePersonalLinkedNotebooks != other.IncludePersonalLinkedNotebooks {
    if p.IncludePersonalLinkedNotebooks == nil || other.IncludePersonalLinkedNotebooks == nil {
      return false
    }
    if (*p.IncludePersonalLinkedNotebooks) != (*other.IncludePersonalLinkedNotebooks) { return false }
  }
  if p.IncludeBusinessLinkedNotebooks != other.IncludeBusinessLinkedNotebooks {
    if p.IncludeBusinessLinkedNotebooks == nil || other.IncludeBusinessLinkedNotebooks == nil {
      return false
    }
    if (*p.IncludeBusinessLinkedNotebooks) != (*other.IncludeBusinessLinkedNotebooks) { return false }
  }
  return true
}
...
func (p *SavedSearch) Equals(other *SavedSearch) bool {
  if p == other {
    return true
  } else if p == nil || other == nil {
    return false
  ...
  if !p.Scope.Equals(other.Scope) { return false }
  return true
}
...
func (p *SharedNotebookRecipientSettings) Equals(other *SharedNotebookRecipientSettings) bool {
  if p == other {
    return true
  } else if p == nil || other == nil {
    return false
  }
  if p.ReminderNotifyEmail != other.ReminderNotifyEmail {
    if p.ReminderNotifyEmail == nil || other.ReminderNotifyEmail == nil {
      return false
    }
    if (*p.ReminderNotifyEmail) != (*other.ReminderNotifyEmail) { return false }
  }
  if p.ReminderNotifyInApp != other.ReminderNotifyInApp {
    if p.ReminderNotifyInApp == nil || other.ReminderNotifyInApp == nil {
      return false
    }
    if (*p.ReminderNotifyInApp) != (*other.ReminderNotifyInApp) { return false }
  }
  return true
}
...
func (p *NotebookRecipientSettings) Read(ctx context.Context, iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(ctx); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *NotebookRecipientSettings)  ReadField1(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadBool(ctx); err != nil {
  return thrift.PrependError("error reading field 1: ", err)
} else {
  p.ReminderNotifyEmail = &v
...
func (p *NotebookRecipientSettings)  ReadField2(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadBool(ctx); err != nil {
  return thrift.PrependError("error reading field 2: ", err)
} else {
  p.ReminderNotifyInApp = &v
...
func (p *NotebookRecipientSettings)  ReadField3(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadBool(ctx); err != nil {
  return thrift.PrependError("error reading field 3: ", err)
} else {
  p.InMyList = &v
...
func (p *NotebookRecipientSettings)  ReadField4(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(ctx); err != nil {
  return thrift.PrependError("error reading field 4: ", err)
} else {
  p.Stack = &v
...
func (p *NotebookRecipientSettings)  ReadField5(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(ctx); err != nil {
  return thrift.PrependError("error reading field 5: ", err)
} else {
...
func (p *NotebookRecipientSettings) Write(ctx context.Context, oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin(ctx, "NotebookRecipientSettings"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if p != nil {
    if err := p.writeField1(ctx, oprot); err != nil { return err }
    if err := p.writeField2(ctx, oprot); err != nil { return err }
...
func (p *NotebookRecipientSettings) writeField1(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetReminderNotifyEmail() {
    if err := oprot.WriteFieldBegin(ctx, "reminderNotifyEmail", thrift.BOOL, 1); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:reminderNotifyEmail: ", p), err) }
    if err := oprot.WriteBool(ctx, bool(*p.ReminderNotifyEmail)); err != nil {
...
func (p *NotebookRecipientSettings) writeField2(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetReminderNotifyInApp() {
    if err := oprot.WriteFieldBegin(ctx, "reminderNotifyInApp", thrift.BOOL, 2); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 2:reminderNotifyInApp: ", p), err) }
    if err := oprot.WriteBool(ctx, bool(*p.ReminderNotifyInApp)); err != nil {
...
func (p *NotebookRecipientSettings) writeField3(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetInMyList() {
    if err := oprot.WriteFieldBegin(ctx, "inMyList", thrift.BOOL, 3); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 3:inMyList: ", p), err) }
    if err := oprot.WriteBool(ctx, bool(*p.InMyList)); err != nil {
...
func (p *NotebookRecipientSettings) writeField4(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetStack() {
    if err := oprot.WriteFieldBegin(ctx, "stack", thrift.STRING, 4); err != nil {
...
func (p *NotebookRecipientSettings) writeField5(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetRecipientStatus() {
    if err := oprot.WriteFieldBegin(ctx, "recipientStatus", thrift.I32, 5); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 5:recipientStatus: ", p), err) }
    if err := oprot.WriteI32(ctx, int32(*p.RecipientStatus)); err != nil {
...
func (p *NotebookRecipientSettings) Equals(other *NotebookRecipientSettings) bool {
  if p == other {
    return true
  } else if p == nil || other == nil {
    return false
  ...
  if p.InMyList != other.InMyList {
    if p.InMyList == nil || other.InMyList == nil {
      return false
    }
    if (*p.InMyList) != (*other.InMyList) { return false }
  }
  if p.Stack != other.Stack {
    if p.Stack == nil || other.Stack == nil {
      return false
    }
    if (*p.Stack) != (*other.Stack) { return false }
  }
  if p.RecipientStatus != other.RecipientStatus {
    if p.RecipientStatus == nil || other.RecipientStatus == nil {
      return false
    }
    if (*p.RecipientStatus) != (*other.RecipientStatus) { return false }
  }
  return true
}
...
func (p *SharedNotebook)  ReadField18(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(ctx); err != nil {
  return thrift.PrependError("error reading field 18: ", err)
} else {
  temp := IdentityID(v)
...
func (p *SharedNotebook)  ReadField14(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(ctx); err != nil {
  return thrift.PrependError("error reading field 14: ", err)
} else {
  temp := UserID(v)
...
func (p *SharedNotebook)  ReadField15(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(ctx); err != nil {
  return thrift.PrependError("error reading field 15: ", err)
} else {
...
func (p *SharedNotebook)  ReadField17(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(ctx); err != nil {
  return thrift.PrependError("error reading field 17: ", err)
} else {
  temp := UserID(v)
...
func (p *SharedNotebook)  ReadField16(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(ctx); err != nil {
  return thrift.PrependError("error reading field 16: ", err)
} else {
  temp := Timestamp(v)
...
func (p *SharedNotebook) writeField8(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetGlobalId() {
    if err := oprot.WriteFieldBegin(ctx, "globalId", thrift.STRING, 8); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 8:globalId: ", p), err) }
    if err := oprot.WriteString(ctx, string(*p.GlobalId)); err != nil {
...
func (p *SharedNotebook) writeField14(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetSharerUserId() {
    if err := oprot.WriteFieldBegin(ctx, "sharerUserId", thrift.I32, 14); err != nil {
...
func (p *SharedNotebook) writeField15(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetRecipientUsername() {
    if err := oprot.WriteFieldBegin(ctx, "recipientUsername", thrift.STRING, 15); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 15:recipientUsername: ", p), err) }
    if err := oprot.WriteString(ctx, string(*p.RecipientUsername)); err != nil {
...
func (p *SharedNotebook) writeField16(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetServiceAssigned() {
    if err := oprot.WriteFieldBegin(ctx, "serviceAssigned", thrift.I64, 16); err != nil {
...
func (p *SharedNotebook) writeField17(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetRecipientUserId() {
    if err := oprot.WriteFieldBegin(ctx, "recipientUserId", thrift.I32, 17); err != nil {
...
func (p *SharedNotebook) writeField18(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetRecipientIdentityId() {
    if err := oprot.WriteFieldBegin(ctx, "recipientIdentityId", thrift.I64, 18); err != nil {
...
func (p *SharedNotebook) Equals(other *SharedNotebook) bool {
  if p == other {
    return true
  } else if p == nil || other == nil {
    return false
  ...
  if p.NotebookModifiable != other.NotebookModifiable {
    if p.NotebookModifiable == nil || other.NotebookModifiable == nil {
      return false
    }
    if (*p.NotebookModifiable) != (*other.NotebookModifiable) { return false }
  }
  if p.ServiceCreated != other.ServiceCreated {
    if p.ServiceCreated == nil || other.ServiceCreated == nil {
      return false
  ...
  if p.GlobalId != other.GlobalId {
    if p.GlobalId == nil || other.GlobalId == nil {
      return false
    }
    if (*p.GlobalId) != (*other.GlobalId) { return false }
  }
  if p.Username != other.Username {
    if p.Username == nil || other.Username == nil {
      return false
  ...
  if !p.RecipientSettings.Equals(other.RecipientSettings) { return false }
  if p.SharerUserId != other.SharerUserId {
    if p.SharerUserId == nil || other.SharerUserId == nil {
      return false
    }
  ...
  if p.RecipientUsername != other.RecipientUsername {
    if p.RecipientUsername == nil || other.RecipientUsername == nil {
      return false
    }
    if (*p.RecipientUsername) != (*other.RecipientUsername) { return false }
  }
  if p.ServiceAssigned != other.ServiceAssigned {
    if p.ServiceAssigned == nil || other.ServiceAssigned == nil {
      return false
...
func (p *CanMoveToContainerRestrictions) Read(ctx context.Context, iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(ctx); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *CanMoveToContainerRestrictions)  ReadField1(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(ctx); err != nil {
  return thrift.PrependError("error reading field 1: ", err)
} else {
...
func (p *CanMoveToContainerRestrictions) Write(ctx context.Context, oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin(ctx, "CanMoveToContainerRestrictions"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if p != nil {
    if err := p.writeField1(ctx, oprot); err != nil { return err }
  }
...
func (p *CanMoveToContainerRestrictions) writeField1(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetCanMoveToContainer() {
    if err := oprot.WriteFieldBegin(ctx, "canMoveToContainer", thrift.I32, 1); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:canMoveToContainer: ", p), err) }
    if err := oprot.WriteI32(ctx, int32(*p.CanMoveToContainer)); err != nil {
...
func (p *CanMoveToContainerRestrictions) Equals(other *CanMoveToContainerRestrictions) bool {
  if p == other {
    return true
  } else if p == nil || other == nil {
    return false
  }
  if p.CanMoveToContainer != other.CanMoveToContainer {
    if p.CanMoveToContainer == nil || other.CanMoveToContainer == nil {
      return false
    }
    if (*p.CanMoveToContainer) != (*other.CanMoveToContainer) { return false }
  }
  return true
}
...
func (p *NotebookRestrictions)  ReadField21(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadBool(ctx); err != nil {
  return thrift.PrependError("error reading field 21: ", err)
} else {
...
func (p *NotebookRestrictions)  ReadField22(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadBool(ctx); err != nil {
  return thrift.PrependError("error reading field 22: ", err)
} else {
...
func (p *NotebookRestrictions)  ReadField23(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadBool(ctx); err != nil {
  return thrift.PrependError("error reading field 23: ", err)
} else {
  p.NoSetInMyList = &v
...
func (p *NotebookRestrictions)  ReadField24(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadBool(ctx); err != nil {
  return thrift.PrependError("error reading field 24: ", err)
} else {
  p.NoChangeContact = &v
...
func (p *NotebookRestrictions)  ReadField26(ctx context.Context, iprot thrift.TProtocol) error {
  p.CanMoveToContainerRestrictions = &CanMoveToContainerRestrictions{}
  if err := p.CanMoveToContainerRestrictions.Read(ctx, iprot); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.CanMoveToContainerRestrictions), err)
  }
  return nil
}

func (p *NotebookRestrictions)  ReadField27(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadBool(ctx); err != nil {
  return thrift.PrependError("error reading field 27: ", err)
} else {
...
func (p *NotebookRestrictions)  ReadField28(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadBool(ctx); err != nil {
  return thrift.PrependError("error reading field 28: ", err)
} else {
...
func (p *NotebookRestrictions)  ReadField29(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadBool(ctx); err != nil {
  return thrift.PrependError("error reading field 29: ", err)
} else {
...
func (p *NotebookRestrictions)  ReadField30(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadBool(ctx); err != nil {
  return thrift.PrependError("error reading field 30: ", err)
} else {
  p.NoCanMoveNote = &v
...
func (p *NotebookRestrictions) writeField21(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetNoShareNotesWithBusiness() {
    if err := oprot.WriteFieldBegin(ctx, "noShareNotesWithBusiness", thrift.BOOL, 21); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 21:noShareNotesWithBusiness: ", p), err) }
    if err := oprot.WriteBool(ctx, bool(*p.NoShareNotesWithBusiness)); err != nil {
...
func (p *NotebookRestrictions) writeField22(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetNoRenameNotebook() {
    if err := oprot.WriteFieldBegin(ctx, "noRenameNotebook", thrift.BOOL, 22); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 22:noRenameNotebook: ", p), err) }
    if err := oprot.WriteBool(ctx, bool(*p.NoRenameNotebook)); err != nil {
...
func (p *NotebookRestrictions) writeField23(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetNoSetInMyList() {
    if err := oprot.WriteFieldBegin(ctx, "noSetInMyList", thrift.BOOL, 23); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 23:noSetInMyList: ", p), err) }
    if err := oprot.WriteBool(ctx, bool(*p.NoSetInMyList)); err != nil {
...
func (p *NotebookRestrictions) writeField24(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetNoChangeContact() {
    if err := oprot.WriteFieldBegin(ctx, "noChangeContact", thrift.BOOL, 24); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 24:noChangeContact: ", p), err) }
    if err := oprot.WriteBool(ctx, bool(*p.NoChangeContact)); err != nil {
...
func (p *NotebookRestrictions) writeField26(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetCanMoveToContainerRestrictions() {
    if err := oprot.WriteFieldBegin(ctx, "canMoveToContainerRestrictions", thrift.STRUCT, 26); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 26:canMoveToContainerRestrictions: ", p), err) }
    if err := p.CanMoveToContainerRestrictions.Write(ctx, oprot); err != nil {
...
func (p *NotebookRestrictions) writeField27(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetNoSetReminderNotifyEmail() {
    if err := oprot.WriteFieldBegin(ctx, "noSetReminderNotifyEmail", thrift.BOOL, 27); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 27:noSetReminderNotifyEmail: ", p), err) }
    if err := oprot.WriteBool(ctx, bool(*p.NoSetReminderNotifyEmail)); err != nil {
...
func (p *NotebookRestrictions) writeField28(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetNoSetReminderNotifyInApp() {
    if err := oprot.WriteFieldBegin(ctx, "noSetReminderNotifyInApp", thrift.BOOL, 28); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 28:noSetReminderNotifyInApp: ", p), err) }
    if err := oprot.WriteBool(ctx, bool(*p.NoSetReminderNotifyInApp)); err != nil {
...
func (p *NotebookRestrictions) writeField29(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetNoSetRecipientSettingsStack() {
    if err := oprot.WriteFieldBegin(ctx, "noSetRecipientSettingsStack", thrift.BOOL, 29); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 29:noSetRecipientSettingsStack: ", p), err) }
    if err := oprot.WriteBool(ctx, bool(*p.NoSetRecipientSettingsStack)); err != nil {
...
func (p *NotebookRestrictions) writeField30(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetNoCanMoveNote() {
    if err := oprot.WriteFieldBegin(ctx, "noCanMoveNote", thrift.BOOL, 30); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 30:noCanMoveNote: ", p), err) }
    if err := oprot.WriteBool(ctx, bool(*p.NoCanMoveNote)); err != nil {
...
func (p *NotebookRestrictions) Equals(other *NotebookRestrictions) bool {
  if p == other {
    return true
  } else if p == nil || other == nil {
    return false
  }
  if p.NoReadNotes != other.NoReadNotes {
    if p.NoReadNotes == nil || other.NoReadNotes == nil {
      return false
    }
    if (*p.NoReadNotes) != (*other.NoReadNotes) { return false }
  }
  if p.NoCreateNotes != other.NoCreateNotes {
    if p.NoCreateNotes == nil || other.NoCreateNotes == nil {
      return false
    }
    if (*p.NoCreateNotes) != (*other.NoCreateNotes) { return false }
  }
  if p.NoUpdateNotes != other.NoUpdateNotes {
    if p.NoUpdateNotes == nil || other.NoUpdateNotes == nil {
      return false
    }
    if (*p.NoUpdateNotes) != (*other.NoUpdateNotes) { return false }
  }
  if p.NoExpungeNotes != other.NoExpungeNotes {
    if p.NoExpungeNotes == nil || other.NoExpungeNotes == nil {
      return false
    }
    if (*p.NoExpungeNotes) != (*other.NoExpungeNotes) { return false }
  }
  if p.NoShareNotes != other.NoShareNotes {
    if p.NoShareNotes == nil || other.NoShareNotes == nil {
      return false
    }
    if (*p.NoShareNotes) != (*other.NoShareNotes) { return false }
  }
  if p.NoEmailNotes != other.NoEmailNotes {
    if p.NoEmailNotes == nil || other.NoEmailNotes == nil {
      return false
    }
    if (*p.NoEmailNotes) != (*other.NoEmailNotes) { return false }
  }
  if p.NoSendMessageToRecipients != other.NoSendMessageToRecipients {
    if p.NoSendMessageToRecipients == nil || other.NoSendMessageToRecipients == nil {
      return false
    }
    if (*p.NoSendMessageToRecipients) != (*other.NoSendMessageToRecipients) { return false }
  }
  if p.NoUpdateNotebook != other.NoUpdateNotebook {
    if p.NoUpdateNotebook == nil || other.NoUpdateNotebook == nil {
      return false
    }
    if (*p.NoUpdateNotebook) != (*other.NoUpdateNotebook) { return false }
  }
  if p.NoExpungeNotebook != other.NoExpungeNotebook {
    if p.NoExpungeNotebook == nil || other.NoExpungeNotebook == nil {
      return false
    }
    if (*p.NoExpungeNotebook) != (*other.NoExpungeNotebook) { return false }
  }
  if p.NoSetDefaultNotebook != other.NoSetDefaultNotebook {
    if p.NoSetDefaultNotebook == nil || other.NoSetDefaultNotebook == nil {
      return false
    }
    if (*p.NoSetDefaultNotebook) != (*other.NoSetDefaultNotebook) { return false }
  }
  if p.NoSetNotebookStack != other.NoSetNotebookStack {
    if p.NoSetNotebookStack == nil || other.NoSetNotebookStack == nil {
      return false
    }
    if (*p.NoSetNotebookStack) != (*other.NoSetNotebookStack) { return false }
  }
  if p.NoPublishToPublic != other.NoPublishToPublic {
    if p.NoPublishToPublic == nil || other.NoPublishToPublic == nil {
      return false
    }
    if (*p.NoPublishToPublic) != (*other.NoPublishToPublic) { return false }
  }
  if p.NoPublishToBusinessLibrary != other.NoPublishToBusinessLibrary {
    if p.NoPublishToBusinessLibrary == nil || other.NoPublishToBusinessLibrary == nil {
      return false
    }
    if (*p.NoPublishToBusinessLibrary) != (*other.NoPublishToBusinessLibrary) { return false }
  }
  if p.NoCreateTags != other.NoCreateTags {
    if p.NoCreateTags == nil || other.NoCreateTags == nil {
      return false
    }
    if (*p.NoCreateTags) != (*other.NoCreateTags) { return false }
  }
  if p.NoUpdateTags != other.NoUpdateTags {
    if p.NoUpdateTags == nil || other.NoUpdateTags == nil {
      return false
    }
    if (*p.NoUpdateTags) != (*other.NoUpdateTags) { return false }
  }
  if p.NoExpungeTags != other.NoExpungeTags {
    if p.NoExpungeTags == nil || other.NoExpungeTags == nil {
      return false
    }
    if (*p.NoExpungeTags) != (*other.NoExpungeTags) { return false }
  }
  if p.NoSetParentTag != other.NoSetParentTag {
    if p.NoSetParentTag == nil || other.NoSetParentTag == nil {
      return false
    }
    if (*p.NoSetParentTag) != (*other.NoSetParentTag) { return false }
  }
  if p.NoCreateSharedNotebooks != other.NoCreateSharedNotebooks {
    if p.NoCreateSharedNotebooks == nil || other.NoCreateSharedNotebooks == nil {
      return false
    }
    if (*p.NoCreateSharedNotebooks) != (*other.NoCreateSharedNotebooks) { return false }
  }
  if p.UpdateWhichSharedNotebookRestrictions != other.UpdateWhichSharedNotebookRestrictions {
    if p.UpdateWhichSharedNotebookRestrictions == nil || other.UpdateWhichSharedNotebookRestrictions == nil {
      return false
    }
    if (*p.UpdateWhichSharedNotebookRestrictions) != (*other.UpdateWhichSharedNotebookRestrictions) { return false }
  }
  if p.ExpungeWhichSharedNotebookRestrictions != other.ExpungeWhichSharedNotebookRestrictions {
    if p.ExpungeWhichSharedNotebookRestrictions == nil || other.ExpungeWhichSharedNotebookRestrictions == nil {
      return false
    }
    if (*p.ExpungeWhichSharedNotebookRestrictions) != (*other.ExpungeWhichSharedNotebookRestrictions) { return false }
  }
  if p.NoShareNotesWithBusiness != other.NoShareNotesWithBusiness {
    if p.NoShareNotesWithBusiness == nil || other.NoShareNotesWithBusiness == nil {
      return false
    }
    if (*p.NoShareNotesWithBusiness) != (*other.NoShareNotesWithBusiness) { return false }
  }
  if p.NoRenameNotebook != other.NoRenameNotebook {
    if p.NoRenameNotebook == nil || other.NoRenameNotebook == nil {
      return false
    }
    if (*p.NoRenameNotebook) != (*other.NoRenameNotebook) { return false }
  }
  if p.NoSetInMyList != other.NoSetInMyList {
    if p.NoSetInMyList == nil || other.NoSetInMyList == nil {
      return false
    }
    if (*p.NoSetInMyList) != (*other.NoSetInMyList) { return false }
  }
  if p.NoChangeContact != other.NoChangeContact {
    if p.NoChangeContact == nil || other.NoChangeContact == nil {
      return false
    }
    if (*p.NoChangeContact) != (*other.NoChangeContact) { return false }
  }
  if !p.CanMoveToContainerRestrictions.Equals(other.CanMoveToContainerRestrictions) { return false }
  if p.NoSetReminderNotifyEmail != other.NoSetReminderNotifyEmail {
    if p.NoSetReminderNotifyEmail == nil || other.NoSetReminderNotifyEmail == nil {
      return false
    }
    if (*p.NoSetReminderNotifyEmail) != (*other.NoSetReminderNotifyEmail) { return false }
  }
  if p.NoSetReminderNotifyInApp != other.NoSetReminderNotifyInApp {
    if p.NoSetReminderNotifyInApp == nil || other.NoSetReminderNotifyInApp == nil {
      return false
    }
    if (*p.NoSetReminderNotifyInApp) != (*other.NoSetReminderNotifyInApp) { return false }
  }
  if p.NoSetRecipientSettingsStack != other.NoSetRecipientSettingsStack {
    if p.NoSetRecipientSettingsStack == nil || other.NoSetRecipientSettingsStack == nil {
      return false
    }
    if (*p.NoSetRecipientSettingsStack) != (*other.NoSetRecipientSettingsStack) { return false }
  }
  if p.NoCanMoveNote != other.NoCanMoveNote {
    if p.NoCanMoveNote == nil || other.NoCanMoveNote == nil {
      return false
    }
    if (*p.NoCanMoveNote) != (*other.NoCanMoveNote) { return false }
  }
  return true
}
...
var _elem20 int64
    ...
    p.SharedNotebookIds = append(p.SharedNotebookIds, _elem20)
  }
  if err := iprot.ReadListEnd(ctx); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *Notebook)  ReadField18(ctx context.Context, iprot thrift.TProtocol) error {
...
func (p *Notebook) writeField18(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetRecipientSettings() {
    if err := oprot.WriteFieldBegin(ctx, "recipientSettings", thrift.STRUCT, 18); err != nil {
...
func (p *Notebook) Equals(other *Notebook) bool {
  if p == other {
    return true
  } else if p == nil || other == nil {
    return false
  ...
  if p.DefaultNotebook != other.DefaultNotebook {
    if p.DefaultNotebook == nil || other.DefaultNotebook == nil {
      return false
    }
    if (*p.DefaultNotebook) != (*other.DefaultNotebook) { return false }
  }
  if p.ServiceCreated != other.ServiceCreated {
    if p.ServiceCreated == nil || other.ServiceCreated == nil {
      return false
  ...
  if !p.Publishing.Equals(other.Publishing) { return false }
  if p.Published != other.Published {
    if p.Published == nil || other.Published == nil {
      return false
    }
    if (*p.Published) != (*other.Published) { return false }
  }
  if p.Stack != other.Stack {
    if p.Stack == nil || other.Stack == nil {
      return false
  ...
  if len(p.SharedNotebookIds) != len(other.SharedNotebookIds) { return false }
  for i, _tgt := range p.SharedNotebookIds {
    _src22 := other.SharedNotebookIds[i]
    if _tgt != _src22 { return false }
  }
  if len(p.SharedNotebooks) != len(other.SharedNotebooks) { return false }
  for i, _tgt := range p.SharedNotebooks {
    _src23 := other.SharedNotebooks[i]
    if !_tgt.Equals(_src23) { return false }
  }
  if !p.BusinessNotebook.Equals(other.BusinessNotebook) { return false }
  if !p.Contact.Equals(other.Contact) { return false }
  if !p.Restrictions.Equals(other.Restrictions) { return false }
  if !p.RecipientSettings.Equals(other.RecipientSettings) { return false }
  return true
...
func (p *LinkedNotebook) writeField5(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetSharedNotebookGlobalId() {
    if err := oprot.WriteFieldBegin(ctx, "sharedNotebookGlobalId", thrift.STRING, 5); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 5:sharedNotebookGlobalId: ", p), err) }
    if err := oprot.WriteString(ctx, string(*p.SharedNotebookGlobalId)); err != nil {
...
func (p *LinkedNotebook) Equals(other *LinkedNotebook) bool {
  if p == other {
    return true
  } else if p == nil || other == nil {
    return false
  }
  if p.ShareName != other.ShareName {
    if p.ShareName == nil || other.ShareName == nil {
      return false
    }
    if (*p.ShareName) != (*other.ShareName) { return false }
  }
  if p.Username != other.Username {
    if p.Username == nil || other.Username == nil {
      return false
  ...
  if p.SharedNotebookGlobalId != other.SharedNotebookGlobalId {
    if p.SharedNotebookGlobalId == nil || other.SharedNotebookGlobalId == nil {
      return false
    }
    if (*p.SharedNotebookGlobalId) != (*other.SharedNotebookGlobalId) { return false }
  }
  if p.URI != other.URI {
    if p.URI == nil || other.URI == nil {
      return false
...
func (p *NotebookDescriptor) Equals(other *NotebookDescriptor) bool {
  if p == other {
    return true
  } else if p == nil || other == nil {
    return false
  ...
  if p.NotebookDisplayName != other.NotebookDisplayName {
    if p.NotebookDisplayName == nil || other.NotebookDisplayName == nil {
      return false
    }
    if (*p.NotebookDisplayName) != (*other.NotebookDisplayName) { return false }
  }
  if p.ContactName != other.ContactName {
    if p.ContactName == nil || other.ContactName == nil {
      return false
    }
    if (*p.ContactName) != (*other.ContactName) { return false }
  }
  if p.HasSharedNotebook != other.HasSharedNotebook {
    if p.HasSharedNotebook == nil || other.HasSharedNotebook == nil {
      return false
    }
    if (*p.HasSharedNotebook) != (*other.HasSharedNotebook) { return false }
  }
  if p.JoinedUserCount != other.JoinedUserCount {
    if p.JoinedUserCount == nil || other.JoinedUserCount == nil {
      return false
    }
    if (*p.JoinedUserCount) != (*other.JoinedUserCount) { return false }
  }
  return true
}
...
func (p *UserProfile)  ReadField4(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(ctx); err != nil {
  return thrift.PrependError("error reading field 4: ", err)
} else {
  p.Username = &v
...
func (p *UserProfile)  ReadField5(ctx context.Context, iprot thrift.TProtocol) error {
...
func (p *UserProfile)  ReadField6(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(ctx); err != nil {
  return thrift.PrependError("error reading field 6: ", err)
} else {
  temp := Timestamp(v)
...
func (p *UserProfile)  ReadField7(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(ctx); err != nil {
  return thrift.PrependError("error reading field 7: ", err)
} else {
  temp := Timestamp(v)
...
func (p *UserProfile)  ReadField8(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(ctx); err != nil {
  return thrift.PrependError("error reading field 8: ", err)
} else {
  p.PhotoUrl = &v
...
func (p *UserProfile)  ReadField9(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(ctx); err != nil {
  return thrift.PrependError("error reading field 9: ", err)
} else {
  temp := BusinessUserRole(v)
...
func (p *UserProfile)  ReadField10(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(ctx); err != nil {
  return thrift.PrependError("error reading field 10: ", err)
} else {
...
func (p *UserProfile) writeField4(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetUsername() {
...
func (p *UserProfile) writeField5(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetAttributes() {
    if err := oprot.WriteFieldBegin(ctx, "attributes", thrift.STRUCT, 5); err != nil {
...
func (p *UserProfile) writeField6(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetJoined() {
    if err := oprot.WriteFieldBegin(ctx, "joined", thrift.I64, 6); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 6:joined: ", p), err) }
    if err := oprot.WriteI64(ctx, int64(*p.Joined)); err != nil {
...
func (p *UserProfile) writeField7(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetPhotoLastUpdated() {
    if err := oprot.WriteFieldBegin(ctx, "photoLastUpdated", thrift.I64, 7); err != nil {
...
func (p *UserProfile) writeField8(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetPhotoUrl() {
    if err := oprot.WriteFieldBegin(ctx, "photoUrl", thrift.STRING, 8); err != nil {
...
func (p *UserProfile) writeField9(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetRole() {
    if err := oprot.WriteFieldBegin(ctx, "role", thrift.I32, 9); err != nil {
...
func (p *UserProfile) writeField10(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetStatus() {
    if err := oprot.WriteFieldBegin(ctx, "status", thrift.I32, 10); err != nil {
...
func (p *UserProfile) Equals(other *UserProfile) bool {
  ...
  if p.Joined != other.Joined {
    if p.Joined == nil || other.Joined == nil {
      return false
    }
    if (*p.Joined) != (*other.Joined) { return false }
  }
  if p.PhotoLastUpdated != other.PhotoLastUpdated {
    if p.PhotoLastUpdated == nil || other.PhotoLastUpdated == nil {
      return false
...
func (p *RelatedContentImage) Read(ctx context.Context, iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(ctx); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *RelatedContentImage)  ReadField1(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(ctx); err != nil {
  return thrift.PrependError("error reading field 1: ", err)
} else {
  p.URL = &v
...
func (p *RelatedContentImage)  ReadField2(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(ctx); err != nil {
  return thrift.PrependError("error reading field 2: ", err)
} else {
  p.Width = &v
...
func (p *RelatedContentImage)  ReadField3(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(ctx); err != nil {
  return thrift.PrependError("error reading field 3: ", err)
} else {
  p.Height = &v
...
func (p *RelatedContentImage)  ReadField4(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadDouble(ctx); err != nil {
  return thrift.PrependError("error reading field 4: ", err)
} else {
  p.PixelRatio = &v
...
func (p *RelatedContentImage)  ReadField5(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(ctx); err != nil {
  return thrift.PrependError("error reading field 5: ", err)
} else {
  p.FileSize = &v
...
func (p *RelatedContentImage) Write(ctx context.Context, oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin(ctx, "RelatedContentImage"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if p != nil {
    if err := p.writeField1(ctx, oprot); err != nil { return err }
    if err := p.writeField2(ctx, oprot); err != nil { return err }
...
func (p *RelatedContentImage) writeField1(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetURL() {
...
func (p *RelatedContentImage) writeField2(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetWidth() {
...
func (p *RelatedContentImage) writeField3(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetHeight() {
...
func (p *RelatedContentImage) writeField4(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetPixelRatio() {
    if err := oprot.WriteFieldBegin(ctx, "pixelRatio", thrift.DOUBLE, 4); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 4:pixelRatio: ", p), err) }
    if err := oprot.WriteDouble(ctx, float64(*p.PixelRatio)); err != nil {
...
func (p *RelatedContentImage) writeField5(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetFileSize() {
    if err := oprot.WriteFieldBegin(ctx, "fileSize", thrift.I32, 5); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 5:fileSize: ", p), err) }
    if err := oprot.WriteI32(ctx, int32(*p.FileSize)); err != nil {
...
func (p *RelatedContentImage) Equals(other *RelatedContentImage) bool {
  if p == other {
    return true
  } else if p == nil || other == nil {
    return false
  ...
  if p.PixelRatio != other.PixelRatio {
    if p.PixelRatio == nil || other.PixelRatio == nil {
      return false
    }
    if (*p.PixelRatio) != (*other.PixelRatio) { return false }
  }
...
func (p *RelatedContent) Read(ctx context.Context, iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(ctx); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *RelatedContent)  ReadField1(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(ctx); err != nil {
  return thrift.PrependError("error reading field 1: ", err)
} else {
  p.ContentId = &v
...
func (p *RelatedContent)  ReadField2(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(ctx); err != nil {
  return thrift.PrependError("error reading field 2: ", err)
} else {
  p.Title = &v
...
func (p *RelatedContent)  ReadField3(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(ctx); err != nil {
  return thrift.PrependError("error reading field 3: ", err)
} else {
  p.URL = &v
...
func (p *RelatedContent)  ReadField4(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(ctx); err != nil {
  return thrift.PrependError("error reading field 4: ", err)
} else {
  p.SourceId = &v
...
func (p *RelatedContent)  ReadField5(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(ctx); err != nil {
  return thrift.PrependError("error reading field 5: ", err)
} else {
  p.SourceUrl = &v
...
func (p *RelatedContent)  ReadField6(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(ctx); err != nil {
  return thrift.PrependError("error reading field 6: ", err)
} else {
...
func (p *RelatedContent)  ReadField7(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(ctx); err != nil {
  return thrift.PrependError("error reading field 7: ", err)
} else {
  p.SourceName = &v
...
func (p *RelatedContent)  ReadField8(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(ctx); err != nil {
  return thrift.PrependError("error reading field 8: ", err)
} else {
  temp := Timestamp(v)
...
func (p *RelatedContent)  ReadField9(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(ctx); err != nil {
  return thrift.PrependError("error reading field 9: ", err)
} else {
  p.Teaser = &v
...
func (p *RelatedContent)  ReadField10(ctx context.Context, iprot thrift.TProtocol) error {
  _, size, err := iprot.ReadListBegin(ctx)
  if err != nil {
    return thrift.PrependError("error reading list begin: ", err)
  }
...
func (p *RelatedContent)  ReadField11(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(ctx); err != nil {
  return thrift.PrependError("error reading field 11: ", err)
} else {
...
func (p *RelatedContent)  ReadField12(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(ctx); err != nil {
  return thrift.PrependError("error reading field 12: ", err)
} else {
...
func (p *RelatedContent)  ReadField13(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(ctx); err != nil {
  return thrift.PrependError("error reading field 13: ", err)
} else {
  p.VisibleUrl = &v
...
func (p *RelatedContent)  ReadField14(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(ctx); err != nil {
  return thrift.PrependError("error reading field 14: ", err)
} else {
  p.ClipUrl = &v
...
func (p *RelatedContent)  ReadField15(ctx context.Context, iprot thrift.TProtocol) error {
  p.Contact = &Contact{}
  if err := p.Contact.Read(ctx, iprot); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.Contact), err)
  }
...
func (p *RelatedContent)  ReadField16(ctx context.Context, iprot thrift.TProtocol) error {
  _, size, err := iprot.ReadListBegin(ctx)
  if err != nil {
    return thrift.PrependError("error reading list begin: ", err)
  }
...
var _elem25 string
    ...
    p.Authors = append(p.Authors, _elem25)
  }
  if err := iprot.ReadListEnd(ctx); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *RelatedContent) Write(ctx context.Context, oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin(ctx, "RelatedContent"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if p != nil {
    if err := p.writeField1(ctx, oprot); err != nil { return err }
    if err := p.writeField2(ctx, oprot); err != nil { return err }
...
func (p *RelatedContent) writeField1(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetContentId() {
    if err := oprot.WriteFieldBegin(ctx, "contentId", thrift.STRING, 1); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:contentId: ", p), err) }
    if err := oprot.WriteString(ctx, string(*p.ContentId)); err != nil {
...
func (p *RelatedContent) writeField2(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetTitle() {
    if err := oprot.WriteFieldBegin(ctx, "title", thrift.STRING, 2); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 2:title: ", p), err) }
    if err := oprot.WriteString(ctx, string(*p.Title)); err != nil {
...
func (p *RelatedContent) writeField3(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetURL() {
...
func (p *RelatedContent) writeField4(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetSourceId() {
    if err := oprot.WriteFieldBegin(ctx, "sourceId", thrift.STRING, 4); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 4:sourceId: ", p), err) }
    if err := oprot.WriteString(ctx, string(*p.SourceId)); err != nil {
...
func (p *RelatedContent) writeField5(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetSourceUrl() {
    if err := oprot.WriteFieldBegin(ctx, "sourceUrl", thrift.STRING, 5); err != nil {
...
func (p *RelatedContent) writeField6(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetSourceFaviconUrl() {
    if err := oprot.WriteFieldBegin(ctx, "sourceFaviconUrl", thrift.STRING, 6); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 6:sourceFaviconUrl: ", p), err) }
    if err := oprot.WriteString(ctx, string(*p.SourceFaviconUrl)); err != nil {
...
func (p *RelatedContent) writeField7(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetSourceName() {
    if err := oprot.WriteFieldBegin(ctx, "sourceName", thrift.STRING, 7); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 7:sourceName: ", p), err) }
    if err := oprot.WriteString(ctx, string(*p.SourceName)); err != nil {
...
func (p *RelatedContent) writeField8(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetDate() {
    if err := oprot.WriteFieldBegin(ctx, "date", thrift.I64, 8); err != nil {
...
func (p *RelatedContent) writeField9(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetTeaser() {
    if err := oprot.WriteFieldBegin(ctx, "teaser", thrift.STRING, 9); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 9:teaser: ", p), err) }
    if err := oprot.WriteString(ctx, string(*p.Teaser)); err != nil {
...
func (p *RelatedContent) writeField10(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetThumbnails() {
    if err := oprot.WriteFieldBegin(ctx, "thumbnails", thrift.LIST, 10); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 10:thumbnails: ", p), err) }
    if err := oprot.WriteListBegin(ctx, thrift.STRUCT, len(p.Thumbnails)); err != nil {
      return thrift.PrependError("error writing list begin: ", err)
    }
...
func (p *RelatedContent) writeField11(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetContentType() {
    if err := oprot.WriteFieldBegin(ctx, "contentType", thrift.I32, 11); err != nil {
...
func (p *RelatedContent) writeField12(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetAccessType() {
    if err := oprot.WriteFieldBegin(ctx, "accessType", thrift.I32, 12); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 12:accessType: ", p), err) }
    if err := oprot.WriteI32(ctx, int32(*p.AccessType)); err != nil {
...
func (p *RelatedContent) writeField13(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetVisibleUrl() {
    if err := oprot.WriteFieldBegin(ctx, "visibleUrl", thrift.STRING, 13); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 13:visibleUrl: ", p), err) }
    if err := oprot.WriteString(ctx, string(*p.VisibleUrl)); err != nil {
...
func (p *RelatedContent) writeField14(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetClipUrl() {
    if err := oprot.WriteFieldBegin(ctx, "clipUrl", thrift.STRING, 14); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 14:clipUrl: ", p), err) }
    if err := oprot.WriteString(ctx, string(*p.ClipUrl)); err != nil {
...
func (p *RelatedContent) writeField15(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetContact() {
    if err := oprot.WriteFieldBegin(ctx, "contact", thrift.STRUCT, 15); err != nil {
...
func (p *RelatedContent) writeField16(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetAuthors() {
    if err := oprot.WriteFieldBegin(ctx, "authors", thrift.LIST, 16); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 16:authors: ", p), err) }
    if err := oprot.WriteListBegin(ctx, thrift.STRING, len(p.Authors)); err != nil {
      return thrift.PrependError("error writing list begin: ", err)
    }
...
func (p *RelatedContent) Equals(other *RelatedContent) bool {
  if p == other {
    return true
  } else if p == nil || other == nil {
    return false
  }
  if p.ContentId != other.ContentId {
    if p.ContentId == nil || other.ContentId == nil {
      return false
    }
  ...
  if p.SourceId != other.SourceId {
    if p.SourceId == nil || other.SourceId == nil {
      return false
    }
    if (*p.SourceId) != (*other.SourceId) { return false }
  }
  if p.SourceUrl != other.SourceUrl {
    if p.SourceUrl == nil || other.SourceUrl == nil {
      return false
  ...
  if p.SourceFaviconUrl != other.SourceFaviconUrl {
    if p.SourceFaviconUrl == nil || other.SourceFaviconUrl == nil {
      return false
    }
    if (*p.SourceFaviconUrl) != (*other.SourceFaviconUrl) { return false }
  }
  if p.SourceName != other.SourceName {
    if p.SourceName == nil || other.SourceName == nil {
      return false
    }
    if (*p.SourceName) != (*other.SourceName) { return false }
  }
  if p.Date != other.Date {
    if p.Date == nil || other.Date == nil {
      return false
    }
    if (*p.Date) != (*other.Date) { return false }
  }
  if p.Teaser != other.Teaser {
    if p.Teaser == nil || other.Teaser == nil {
      return false
    }
    if (*p.Teaser) != (*other.Teaser) { return false }
  }
  if len(p.Thumbnails) != len(other.Thumbnails) { return false }
  for i, _tgt := range p.Thumbnails {
    _src26 := other.Thumbnails[i]
  ...
  if p.AccessType != other.AccessType {
    if p.AccessType == nil || other.AccessType == nil {
      return false
    }
    if (*p.AccessType) != (*other.AccessType) { return false }
  }
  if p.VisibleUrl != other.VisibleUrl {
    if p.VisibleUrl == nil || other.VisibleUrl == nil {
      return false
    }
    if (*p.VisibleUrl) != (*other.VisibleUrl) { return false }
  }
  if p.ClipUrl != other.ClipUrl {
    if p.ClipUrl == nil || other.ClipUrl == nil {
      return false
    }
    if (*p.ClipUrl) != (*other.ClipUrl) { return false }
  }
  if !p.Contact.Equals(other.Contact) { return false }
  if len(p.Authors) != len(other.Authors) { return false }
  for i, _tgt := range p.Authors {
    _src27 := other.Authors[i]
...
func (p *BusinessInvitation) Read(ctx context.Context, iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(ctx); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *BusinessInvitation)  ReadField1(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(ctx); err != nil {
  return thrift.PrependError("error reading field 1: ", err)
} else {
  p.BusinessId = &v
...
func (p *BusinessInvitation)  ReadField2(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(ctx); err != nil {
  return thrift.PrependError("error reading field 2: ", err)
} else {
  p.Email = &v
...
func (p *BusinessInvitation)  ReadField3(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(ctx); err != nil {
  return thrift.PrependError("error reading field 3: ", err)
} else {
  temp := BusinessUserRole(v)
...
func (p *BusinessInvitation)  ReadField4(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(ctx); err != nil {
  return thrift.PrependError("error reading field 4: ", err)
} else {
...
func (p *BusinessInvitation)  ReadField5(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(ctx); err != nil {
  return thrift.PrependError("error reading field 5: ", err)
} else {
  temp := UserID(v)
...
func (p *BusinessInvitation)  ReadField6(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadBool(ctx); err != nil {
  return thrift.PrependError("error reading field 6: ", err)
} else {
  p.FromWorkChat = &v
...
func (p *BusinessInvitation)  ReadField7(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(ctx); err != nil {
  return thrift.PrependError("error reading field 7: ", err)
} else {
  temp := Timestamp(v)
...
func (p *BusinessInvitation)  ReadField8(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(ctx); err != nil {
  return thrift.PrependError("error reading field 8: ", err)
} else {
  temp := Timestamp(v)
...
func (p *BusinessInvitation) Write(ctx context.Context, oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin(ctx, "BusinessInvitation"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if p != nil {
    if err := p.writeField1(ctx, oprot); err != nil { return err }
    if err := p.writeField2(ctx, oprot); err != nil { return err }
...
func (p *BusinessInvitation) writeField1(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetBusinessId() {
    if err := oprot.WriteFieldBegin(ctx, "businessId", thrift.I32, 1); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:businessId: ", p), err) }
    if err := oprot.WriteI32(ctx, int32(*p.BusinessId)); err != nil {
...
func (p *BusinessInvitation) writeField2(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetEmail() {
...
func (p *BusinessInvitation) writeField3(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetRole() {
    if err := oprot.WriteFieldBegin(ctx, "role", thrift.I32, 3); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 3:role: ", p), err) }
    if err := oprot.WriteI32(ctx, int32(*p.Role)); err != nil {
...
func (p *BusinessInvitation) writeField4(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetStatus() {
...
func (p *BusinessInvitation) writeField5(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetRequesterId() {
    if err := oprot.WriteFieldBegin(ctx, "requesterId", thrift.I32, 5); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 5:requesterId: ", p), err) }
    if err := oprot.WriteI32(ctx, int32(*p.RequesterId)); err != nil {
...
func (p *BusinessInvitation) writeField6(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetFromWorkChat() {
    if err := oprot.WriteFieldBegin(ctx, "fromWorkChat", thrift.BOOL, 6); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 6:fromWorkChat: ", p), err) }
    if err := oprot.WriteBool(ctx, bool(*p.FromWorkChat)); err != nil {
...
func (p *BusinessInvitation) writeField7(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetCreated() {
    if err := oprot.WriteFieldBegin(ctx, "created", thrift.I64, 7); err != nil {
...
func (p *BusinessInvitation) writeField8(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetMostRecentReminder() {
    if err := oprot.WriteFieldBegin(ctx, "mostRecentReminder", thrift.I64, 8); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 8:mostRecentReminder: ", p), err) }
    if err := oprot.WriteI64(ctx, int64(*p.MostRecentReminder)); err != nil {
...
func (p *BusinessInvitation) Equals(other *BusinessInvitation) bool {
  if p == other {
    return true
  } else if p == nil || other == nil {
    return false
  ...
  if p.RequesterId != other.RequesterId {
    if p.RequesterId == nil || other.RequesterId == nil {
      return false
    }
    if (*p.RequesterId) != (*other.RequesterId) { return false }
  }
  if p.FromWorkChat != other.FromWorkChat {
    if p.FromWorkChat == nil || other.FromWorkChat == nil {
      return false
    }
    if (*p.FromWorkChat) != (*other.FromWorkChat) { return false }
  }
  if p.Created != other.Created {
    if p.Created == nil || other.Created == nil {
      return false
  ...
  if p.MostRecentReminder != other.MostRecentReminder {
    if p.MostRecentReminder == nil || other.MostRecentReminder == nil {
      return false
    }
    if (*p.MostRecentReminder) != (*other.MostRecentReminder) { return false }
  }
  return true
}
...
func (p *UserIdentity) Read(ctx context.Context, iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(ctx); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *UserIdentity)  ReadField1(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(ctx); err != nil {
  return thrift.PrependError("error reading field 1: ", err)
} else {
...
func (p *UserIdentity)  ReadField2(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(ctx); err != nil {
  return thrift.PrependError("error reading field 2: ", err)
} else {
...
func (p *UserIdentity)  ReadField3(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(ctx); err != nil {
  return thrift.PrependError("error reading field 3: ", err)
} else {
  p.LongIdentifier = &v
...
func (p *UserIdentity) Write(ctx context.Context, oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin(ctx, "UserIdentity"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if p != nil {
    if err := p.writeField1(ctx, oprot); err != nil { return err }
    if err := p.writeField2(ctx, oprot); err != nil { return err }
...
func (p *UserIdentity) writeField1(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetType() {
...
func (p *UserIdentity) writeField2(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetStringIdentifier() {
    if err := oprot.WriteFieldBegin(ctx, "stringIdentifier", thrift.STRING, 2); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 2:stringIdentifier: ", p), err) }
    if err := oprot.WriteString(ctx, string(*p.StringIdentifier)); err != nil {
...
func (p *UserIdentity) writeField3(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetLongIdentifier() {
    if err := oprot.WriteFieldBegin(ctx, "longIdentifier", thrift.I64, 3); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 3:longIdentifier: ", p), err) }
    if err := oprot.WriteI64(ctx, int64(*p.LongIdentifier)); err != nil {
...
func (p *UserIdentity) Equals(other *UserIdentity) bool {
  if p == other {
    return true
  } else if p == nil || other == nil {
    return false
  ...
  if p.StringIdentifier != other.StringIdentifier {
    if p.StringIdentifier == nil || other.StringIdentifier == nil {
      return false
    }
    if (*p.StringIdentifier) != (*other.StringIdentifier) { return false }
  }
  if p.LongIdentifier != other.LongIdentifier {
    if p.LongIdentifier == nil || other.LongIdentifier == nil {
      return false
    }
    if (*p.LongIdentifier) != (*other.LongIdentifier) { return false }
  }
  return true
}
